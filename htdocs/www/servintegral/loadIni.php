<?php
	$itemFolder =  array_keys($_FILES)[0];
		...
		$destination_path = "/home/leoncitobravo/public_html/servintegral/irsc/pics/".$itemFolder."/ini/";
		
		// $destination_path = "/xampp/htdocs/www/servintegral/irsc/pics/".$itemFolder."/ini/";
