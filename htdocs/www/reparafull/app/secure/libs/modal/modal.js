...
function confirmBox(title,content,method,wide,param)
{
	...
	// if(actualMainColor)
	// {
		// modalArea.style.border  = "5px solid #272E36";
		// aceptb.style.background = actualMainColor;
		// cancelb.style.background = actualMainColor;
	// }
...
function hide_pop_form()
{
	...
	{document.getElementById("picSelector").value = "";}
	if(document.getElementById("picSelector2"))
