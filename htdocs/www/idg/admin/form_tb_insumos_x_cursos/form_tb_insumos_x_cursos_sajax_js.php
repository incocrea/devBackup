  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_insumos_x_cursos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_insumos_x_cursos_form();
	}
...
?>
  ...
  // ---------- Validate topico_
  function do_ajax_form_tb_insumos_x_cursos_validate_topico_(iNumLinha)
  {
    var nomeCampo_topico_ = "topico_" + iNumLinha;
    var var_topico_ = scAjaxGetFieldText(nomeCampo_topico_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_insumos_x_cursos_validate_topico_(var_topico_, iNumLinha, var_script_case_init, do_ajax_form_tb_insumos_x_cursos_validate_topico__cb);
  } // do_ajax_form_tb_insumos_x_cursos_validate_topico_

  function do_ajax_form_tb_insumos_x_cursos_validate_topico__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "topico_" + iLineNumber;
    }
    else
    {
      sFieldValid = "topico_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_insumos_x_cursos_validate_topico__cb

  // ---------- Validate documentos_
  function do_ajax_form_tb_insumos_x_cursos_validate_documentos_(iNumLinha)
  {
    var nomeCampo_documentos_ = "documentos_" + iNumLinha;
    var var_documentos_ = scAjaxGetFieldText(nomeCampo_documentos_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_insumos_x_cursos_validate_documentos_(var_documentos_, iNumLinha, var_script_case_init, do_ajax_form_tb_insumos_x_cursos_validate_documentos__cb);
  } // do_ajax_form_tb_insumos_x_cursos_validate_documentos_

  function do_ajax_form_tb_insumos_x_cursos_validate_documentos__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "documentos_" + iLineNumber;
    }
    else
    {
      sFieldValid = "documentos_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_insumos_x_cursos_validate_documentos__cb

  // ---------- Validate videos_
  function do_ajax_form_tb_insumos_x_cursos_validate_videos_(iNumLinha)
  {
    var nomeCampo_videos_ = "videos_" + iNumLinha;
    var var_videos_ = scAjaxGetFieldText(nomeCampo_videos_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_insumos_x_cursos_validate_videos_(var_videos_, iNumLinha, var_script_case_init, do_ajax_form_tb_insumos_x_cursos_validate_videos__cb);
  } // do_ajax_form_tb_insumos_x_cursos_validate_videos_

  function do_ajax_form_tb_insumos_x_cursos_validate_videos__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "videos_" + iLineNumber;
    }
    else
    {
      sFieldValid = "videos_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_insumos_x_cursos_validate_videos__cb

  // ---------- Validate enbed_
  function do_ajax_form_tb_insumos_x_cursos_validate_enbed_(iNumLinha)
  {
    var nomeCampo_enbed_ = "enbed_" + iNumLinha;
    var var_enbed_ = scAjaxGetFieldText(nomeCampo_enbed_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_insumos_x_cursos_validate_enbed_(var_enbed_, iNumLinha, var_script_case_init, do_ajax_form_tb_insumos_x_cursos_validate_enbed__cb);
  } // do_ajax_form_tb_insumos_x_cursos_validate_enbed_

  function do_ajax_form_tb_insumos_x_cursos_validate_enbed__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "enbed_" + iLineNumber;
    }
    else
    {
      sFieldValid = "enbed_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_insumos_x_cursos_validate_enbed__cb

  // ---------- Validate paginas_sugeridas_
  function do_ajax_form_tb_insumos_x_cursos_validate_paginas_sugeridas_(iNumLinha)
  {
    var nomeCampo_paginas_sugeridas_ = "paginas_sugeridas_" + iNumLinha;
    var var_paginas_sugeridas_ = scAjaxGetFieldText(nomeCampo_paginas_sugeridas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_insumos_x_cursos_validate_paginas_sugeridas_(var_paginas_sugeridas_, iNumLinha, var_script_case_init, do_ajax_form_tb_insumos_x_cursos_validate_paginas_sugeridas__cb);
  } // do_ajax_form_tb_insumos_x_cursos_validate_paginas_sugeridas_

  function do_ajax_form_tb_insumos_x_cursos_validate_paginas_sugeridas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "paginas_sugeridas_" + iLineNumber;
    }
    else
    {
      sFieldValid = "paginas_sugeridas_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_insumos_x_cursos_validate_paginas_sugeridas__cb

  // ---------- Validate recomendaciones_
  function do_ajax_form_tb_insumos_x_cursos_validate_recomendaciones_(iNumLinha)
  {
    var nomeCampo_recomendaciones_ = "recomendaciones_" + iNumLinha;
    var var_recomendaciones_ = scAjaxGetFieldText(nomeCampo_recomendaciones_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_insumos_x_cursos_validate_recomendaciones_(var_recomendaciones_, iNumLinha, var_script_case_init, do_ajax_form_tb_insumos_x_cursos_validate_recomendaciones__cb);
  } // do_ajax_form_tb_insumos_x_cursos_validate_recomendaciones_

  function do_ajax_form_tb_insumos_x_cursos_validate_recomendaciones__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "recomendaciones_" + iLineNumber;
    }
    else
    {
      sFieldValid = "recomendaciones_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_insumos_x_cursos_validate_recomendaciones__cb

  // ---------- Validate test_
  function do_ajax_form_tb_insumos_x_cursos_validate_test_(iNumLinha)
  {
    var nomeCampo_test_ = "test_" + iNumLinha;
    var var_test_ = scAjaxGetFieldText(nomeCampo_test_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_insumos_x_cursos_validate_test_(var_test_, iNumLinha, var_script_case_init, do_ajax_form_tb_insumos_x_cursos_validate_test__cb);
  } // do_ajax_form_tb_insumos_x_cursos_validate_test_

  function do_ajax_form_tb_insumos_x_cursos_validate_test__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_insumos_x_cursos_validate_test__cb

  // ---------- Validate id_insumos_
  function do_ajax_form_tb_insumos_x_cursos_validate_id_insumos_(iNumLinha)
  {
    var nomeCampo_id_insumos_ = "id_insumos_" + iNumLinha;
    var var_id_insumos_ = scAjaxGetFieldHidden(nomeCampo_id_insumos_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_insumos_x_cursos_validate_id_insumos_(var_id_insumos_, iNumLinha, var_script_case_init, do_ajax_form_tb_insumos_x_cursos_validate_id_insumos__cb);
  } // do_ajax_form_tb_insumos_x_cursos_validate_id_insumos_

  function do_ajax_form_tb_insumos_x_cursos_validate_id_insumos__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_insumos_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_insumos_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_insumos_x_cursos_validate_id_insumos__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tb_insumos_x_cursos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tb_insumos_x_cursos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tb_insumos_x_cursos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tb_insumos_x_cursos_add_new_line_cb);
  } // do_ajax_form_tb_insumos_x_cursos_add_new_line

  function do_ajax_form_tb_insumos_x_cursos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tb_insumos_x_cursos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tb_insumos_x_cursos_backup_line(iNumLinha)
  {
    var var_id_insumos_ = scAjaxGetFieldHidden("id_insumos_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_insumos_x_cursos_backup_line(var_id_insumos_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tb_insumos_x_cursos_backup_line_cb);
  } // do_ajax_form_tb_insumos_x_cursos_backup_line

  function do_ajax_form_tb_insumos_x_cursos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tb_insumos_x_cursos_backup_line_cb

  function do_ajax_form_tb_insumos_x_cursos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_tb_insumos_x_cursos_cancel_insert

  function do_ajax_form_tb_insumos_x_cursos_cancel_update(iSeqVert)
  {
    do_ajax_form_tb_insumos_x_cursos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tb_insumos_x_cursos_cancel_update

  function do_ajax_form_tb_insumos_x_cursos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tb_insumos_x_cursos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tb_insumos_x_cursos_table_refresh()
  {
    var var_id_insumos_ = document.F2.id_insumos_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tb_insumos_x_cursos_table_refresh(var_id_insumos_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_insumos_x_cursos_table_refresh_cb);
  } //  do_ajax_form_tb_insumos_x_cursos_table_refresh

  function do_ajax_form_tb_insumos_x_cursos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_insumos_.value = scAjaxGetKeyValue("id_insumos_");
    ...
    scAjaxAlert(do_ajax_form_tb_insumos_x_cursos_table_refresh_cb_after_alert);
  } // do_ajax_form_tb_insumos_x_cursos_table_refresh_cb
  function do_ajax_form_tb_insumos_x_cursos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tb_insumos_x_cursos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tb_insumos_x_cursos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tb_insumos_x_cursos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_topico_ = scAjaxGetFieldText("topico_" + iNumLinha);
    var var_documentos_ = scAjaxGetFieldText("documentos_" + iNumLinha);
    var var_videos_ = "";
    var var_enbed_ = scAjaxGetFieldText("enbed_" + iNumLinha);
    var var_paginas_sugeridas_ = scAjaxGetFieldText("paginas_sugeridas_" + iNumLinha);
    var var_recomendaciones_ = scAjaxGetFieldText("recomendaciones_" + iNumLinha);
    var var_test_ = scAjaxGetFieldText("test_" + iNumLinha);
    var var_id_insumos_ = scAjaxGetFieldHidden("id_insumos_" + iNumLinha);
    var var_documentos__ul_name = scAjaxSpecCharProtect(eval('document.F1.documentos__ul_name' + iNumLinha + '.value'));
    var var_documentos__ul_type = eval('document.F1.documentos__ul_type' + iNumLinha + '.value');
    var var_documentos__salva = document.F1.elements["documentos_" + iNumLinha + "_salva"] ? eval('document.F1.documentos_' + iNumLinha + '_salva.value') : "";
    var var_documentos__limpa = eval('document.F1.documentos__limpa' + iNumLinha + '.checked') ? "S" : "N";
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tb_insumos_x_cursos_submit_form(var_topico_, var_documentos_, var_videos_, var_enbed_, var_paginas_sugeridas_, var_recomendaciones_, var_test_, var_id_insumos_, var_documentos__ul_name, var_documentos__ul_type, var_documentos__salva, var_documentos__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_insumos_x_cursos_submit_form_cb);
  } // do_ajax_form_tb_insumos_x_cursos_submit_form

  function do_ajax_form_tb_insumos_x_cursos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
<?php
        ...
        {
?>
          if (document.F1.elements["documentos__limpa" + sc_num_ult_line] && document.F1.elements["documentos__limpa" + sc_num_ult_line].checked)
          {
            var oImgTemp = {0: {"value" : ""}};
            scAjaxSetFieldDocument("documentos_" + sc_num_ult_line, oImgTemp, "", "");
            document.F1.elements["documentos__limpa" + sc_num_ult_line].checked = false;
          }
          else if (document.getElementById("id_ajax_doc_documentos_" + sc_num_ult_line) && "" != document.getElementById("id_ajax_doc_documentos_" + sc_num_ult_line).innerHTML)
          {
            document.getElementById("id_ajax_doc_documentos_" + sc_num_ult_line).style.display = "";
          }
<?php
        }
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tb_insumos_x_cursos_submit_form_cb_after_alert);
  } // do_ajax_form_tb_insumos_x_cursos_submit_form_cb
  function do_ajax_form_tb_insumos_x_cursos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_insumos_x_cursos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_insumos_x_cursos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_insumos_x_cursos_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_insumos_x_cursos_navigate_form();
    }
  }

  function perform_ajax_form_tb_insumos_x_cursos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tb_insumos_x_cursos_cancel_insert(sc_form_tb_insumos_x_cursos_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tb_insumos_x_cursos_navigate_form(var_id_insumos_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_insumos_x_cursos_navigate_form_cb);
  } // do_ajax_form_tb_insumos_x_cursos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_insumos_x_cursos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_insumos_x_cursos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_insumos_.value = scAjaxGetKeyValue("id_insumos_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_insumos_x_cursos_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_insumos_x_cursos_navigate_form_cb
  function do_ajax_form_tb_insumos_x_cursos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tb_insumos_x_cursos_navigate_form_cb_after_alert

    function sc_form_tb_insumos_x_cursos_get_last_line_number()
    {
    ...
    } //sc_form_tb_insumos_x_cursos_get_last_line_number

  function sc_hide_form_tb_insumos_x_cursos_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "topico_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "documentos_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "videos_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "enbed_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "paginas_sugeridas_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "recomendaciones_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "test_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_insumos_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["topico_" + iNumLinha] = {"label": "Topico<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["documentos_" + iNumLinha] = {"label": "Documentos<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["videos_" + iNumLinha] = {"label": "Videos<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["enbed_" + iNumLinha] = {"label": "Enbed<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["paginas_sugeridas_" + iNumLinha] = {"label": "Paginas Sugeridas<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["recomendaciones_" + iNumLinha] = {"label": "Recomendaciones<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["test_" + iNumLinha] = {"label": "Test<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["id_insumos_" + iNumLinha] = {"label": "Id Insumos<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["topico_"][iNumLinha] = "topico_" + iNumLinha;
    ajax_field_mult["documentos_"][iNumLinha] = "documentos_" + iNumLinha;
    ajax_field_mult["videos_"][iNumLinha] = "videos_" + iNumLinha;
    ajax_field_mult["enbed_"][iNumLinha] = "enbed_" + iNumLinha;
    ajax_field_mult["paginas_sugeridas_"][iNumLinha] = "paginas_sugeridas_" + iNumLinha;
    ajax_field_mult["recomendaciones_"][iNumLinha] = "recomendaciones_" + iNumLinha;
    ajax_field_mult["test_"][iNumLinha] = "test_" + iNumLinha;
    ajax_field_mult["id_insumos_"][iNumLinha] = "id_insumos_" + iNumLinha;
    ajax_field_id["topico_" + iNumLinha] = new Array("hidden_field_label_topico_", "hidden_field_data_topico_" + iNumLinha);
    ajax_field_id["documentos_" + iNumLinha] = new Array("hidden_field_label_documentos_", "hidden_field_data_documentos_" + iNumLinha);
    ajax_field_id["videos_" + iNumLinha] = new Array("hidden_field_label_videos_", "hidden_field_data_videos_" + iNumLinha);
    ajax_field_id["enbed_" + iNumLinha] = new Array("hidden_field_label_enbed_", "hidden_field_data_enbed_" + iNumLinha);
    ajax_field_id["paginas_sugeridas_" + iNumLinha] = new Array("hidden_field_label_paginas_sugeridas_", "hidden_field_data_paginas_sugeridas_" + iNumLinha);
    ajax_field_id["recomendaciones_" + iNumLinha] = new Array("hidden_field_label_recomendaciones_", "hidden_field_data_recomendaciones_" + iNumLinha);
    ajax_field_id["test_" + iNumLinha] = new Array("hidden_field_label_test_", "hidden_field_data_test_" + iNumLinha);
    ajax_error_count["topico_" + iNumLinha] = "off";
    ajax_error_count["documentos_" + iNumLinha] = "off";
    ajax_error_count["videos_" + iNumLinha] = "off";
    ajax_error_count["enbed_" + iNumLinha] = "off";
    ajax_error_count["paginas_sugeridas_" + iNumLinha] = "off";
    ajax_error_count["recomendaciones_" + iNumLinha] = "off";
    ajax_error_count["test_" + iNumLinha] = "off";
    ajax_error_count["id_insumos_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["topico_" + iNumLinha] = "off";
    ajax_read_only["documentos_" + iNumLinha] = "off";
    ajax_read_only["videos_" + iNumLinha] = "off";
    ajax_read_only["enbed_" + iNumLinha] = "off";
    ajax_read_only["paginas_sugeridas_" + iNumLinha] = "off";
    ajax_read_only["recomendaciones_" + iNumLinha] = "off";
    ajax_read_only["test_" + iNumLinha] = "off";
    ajax_read_only["id_insumos_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["topico_" + iNumLinha] = "on";
    ajax_read_only["documentos_" + iNumLinha] = "on";
    ajax_read_only["videos_" + iNumLinha] = "on";
    ajax_read_only["enbed_" + iNumLinha] = "on";
    ajax_read_only["paginas_sugeridas_" + iNumLinha] = "on";
    ajax_read_only["recomendaciones_" + iNumLinha] = "on";
    ajax_read_only["test_" + iNumLinha] = "on";
    ajax_read_only["id_insumos_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["topico_" + iNumLinha] = null;
    ajax_error_list["documentos_" + iNumLinha] = null;
    ajax_error_list["videos_" + iNumLinha] = null;
    ajax_error_list["enbed_" + iNumLinha] = null;
    ajax_error_list["paginas_sugeridas_" + iNumLinha] = null;
    ajax_error_list["recomendaciones_" + iNumLinha] = null;
    ajax_error_list["test_" + iNumLinha] = null;
    ajax_error_list["id_insumos_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "topico_": new Array(),
    "documentos_": new Array(),
    "videos_": new Array(),
    "enbed_": new Array(),
    "paginas_sugeridas_": new Array(),
    "recomendaciones_": new Array(),
    "test_": new Array(),
    "id_insumos_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["topico_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["topico_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["topico_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["topico_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["topico_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["documentos_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["documentos_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["documentos_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["documentos_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["documentos_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["videos_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["videos_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["videos_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["videos_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["videos_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["enbed_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["enbed_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["enbed_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["enbed_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["enbed_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["paginas_sugeridas_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["paginas_sugeridas_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["paginas_sugeridas_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["paginas_sugeridas_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["paginas_sugeridas_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["recomendaciones_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["recomendaciones_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["recomendaciones_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["recomendaciones_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["recomendaciones_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["test_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["test_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["test_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["test_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["test_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["id_insumos_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_insumos_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_insumos_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_insumos_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_insumos_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['topico_'])) ? $this->nmgp_cmp_readonly['topico_'] : 'off';
?>
    scAjaxFieldRead("topico_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['documentos_'])) ? $this->nmgp_cmp_readonly['documentos_'] : 'off';
?>
    scAjaxFieldRead("documentos_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['videos_'])) ? $this->nmgp_cmp_readonly['videos_'] : 'off';
?>
    scAjaxFieldRead("videos_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['enbed_'])) ? $this->nmgp_cmp_readonly['enbed_'] : 'off';
?>
    scAjaxFieldRead("enbed_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['paginas_sugeridas_'])) ? $this->nmgp_cmp_readonly['paginas_sugeridas_'] : 'off';
?>
    scAjaxFieldRead("paginas_sugeridas_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['recomendaciones_'])) ? $this->nmgp_cmp_readonly['recomendaciones_'] : 'off';
?>
    scAjaxFieldRead("recomendaciones_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['test_'])) ? $this->nmgp_cmp_readonly['test_'] : 'off';
?>
    scAjaxFieldRead("test_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_insumos_'])) ? $this->nmgp_cmp_readonly['id_insumos_'] : 'on';
?>
    scAjaxFieldRead("id_insumos_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("topico_" + iSeq, "on");
    scAjaxFieldRead("documentos_" + iSeq, "on");
    scAjaxFieldRead("videos_" + iSeq, "on");
    scAjaxFieldRead("enbed_" + iSeq, "on");
    scAjaxFieldRead("paginas_sugeridas_" + iSeq, "on");
    scAjaxFieldRead("recomendaciones_" + iSeq, "on");
    scAjaxFieldRead("test_" + iSeq, "on");
    scAjaxFieldRead("id_insumos_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["topico_" + iRow] || "on" == ajax_error_count["documentos_" + iRow] || "on" == ajax_error_count["videos_" + iRow] || "on" == ajax_error_count["enbed_" + iRow] || "on" == ajax_error_count["paginas_sugeridas_" + iRow] || "on" == ajax_error_count["recomendaciones_" + iRow] || "on" == ajax_error_count["test_" + iRow] || "on" == ajax_error_count["id_insumos_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_topico_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_documentos_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_videos_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_enbed_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_paginas_sugeridas_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_recomendaciones_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_test_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_insumos_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["topico_" + iRow] && "off" == ajax_error_count["documentos_" + iRow] && "off" == ajax_error_count["videos_" + iRow] && "off" == ajax_error_count["enbed_" + iRow] && "off" == ajax_error_count["paginas_sugeridas_" + iRow] && "off" == ajax_error_count["recomendaciones_" + iRow] && "off" == ajax_error_count["test_" + iRow] && "off" == ajax_error_count["id_insumos_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["topico_" + iRow] = "off";
        ajax_error_count["documentos_" + iRow] = "off";
        ajax_error_count["videos_" + iRow] = "off";
        ajax_error_count["enbed_" + iRow] = "off";
        ajax_error_count["paginas_sugeridas_" + iRow] = "off";
        ajax_error_count["recomendaciones_" + iRow] = "off";
        ajax_error_count["test_" + iRow] = "off";
        ajax_error_count["id_insumos_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_topico_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_documentos_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_videos_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_enbed_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_paginas_sugeridas_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_recomendaciones_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_test_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_id_insumos_" + iRow).removeClass("scFormErrorLine");
    }
  }
