...
$old_error_handler = set_error_handler("form_tb_insumos_x_cursos_scriptcase_error_handler");

function form_tb_insumos_x_cursos_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['form_tb_insumos_x_cursos']['contr_erro']) && $_SESSION['scriptcase']['form_tb_insumos_x_cursos']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_tb_insumos_x_cursos->contr_form_tb_insumos_x_cursos->Apl_com_erro = true;
            if ($inicial_form_tb_insumos_x_cursos->contr_form_tb_insumos_x_cursos->NM_ajax_flag)
            {
                $inicial_form_tb_insumos_x_cursos->contr_form_tb_insumos_x_cursos->NM_ajax_info['errList']['geral_form_tb_insumos_x_cursos'][] = $msg;
                return;
            }
            form_tb_insumos_x_cursos_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_tb_insumos_x_cursos_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tb_insumos_x_cursos'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tb_insumos_x_cursos'])  ? $_SESSION['scriptcase']['error_icon']['form_tb_insumos_x_cursos']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tb_insumos_x_cursos']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tb_insumos_x_cursos']) ? $_SESSION['scriptcase']['error_span_title']['form_tb_insumos_x_cursos'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tb_insumos_x_cursos']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tb_insumos_x_cursos']) ? $_SESSION['scriptcase']['error_icon_title']['form_tb_insumos_x_cursos'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_tb_insumos_x_cursos']['error_buffer'] .= ob_get_flush();
}
