  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_cursosxinstituciones_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_cursosxinstituciones_mob_form();
	}
...
?>
  ...
  // ---------- Validate institucion_id
  function do_ajax_form_tb_cursosxinstituciones_mob_validate_institucion_id()
  {
    var nomeCampo_institucion_id = "institucion_id";
    var var_institucion_id = scAjaxGetFieldSelect(nomeCampo_institucion_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_cursosxinstituciones_mob_validate_institucion_id(var_institucion_id, var_script_case_init, do_ajax_form_tb_cursosxinstituciones_mob_validate_institucion_id_cb);
  } // do_ajax_form_tb_cursosxinstituciones_mob_validate_institucion_id

  function do_ajax_form_tb_cursosxinstituciones_mob_validate_institucion_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "institucion_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_cursosxinstituciones_mob_validate_institucion_id_cb

  // ---------- Validate course_id
  function do_ajax_form_tb_cursosxinstituciones_mob_validate_course_id()
  {
    var nomeCampo_course_id = "course_id";
    var var_course_id = scAjaxGetFieldSelect(nomeCampo_course_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_cursosxinstituciones_mob_validate_course_id(var_course_id, var_script_case_init, do_ajax_form_tb_cursosxinstituciones_mob_validate_course_id_cb);
  } // do_ajax_form_tb_cursosxinstituciones_mob_validate_course_id

  function do_ajax_form_tb_cursosxinstituciones_mob_validate_course_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_cursosxinstituciones_mob_validate_course_id_cb

  // ---------- Validate estado_id
  function do_ajax_form_tb_cursosxinstituciones_mob_validate_estado_id()
  {
    var nomeCampo_estado_id = "estado_id";
    var var_estado_id = scAjaxGetFieldSelect(nomeCampo_estado_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_cursosxinstituciones_mob_validate_estado_id(var_estado_id, var_script_case_init, do_ajax_form_tb_cursosxinstituciones_mob_validate_estado_id_cb);
  } // do_ajax_form_tb_cursosxinstituciones_mob_validate_estado_id

  function do_ajax_form_tb_cursosxinstituciones_mob_validate_estado_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_cursosxinstituciones_mob_validate_estado_id_cb

  // ---------- Validate fecha_inicio
  function do_ajax_form_tb_cursosxinstituciones_mob_validate_fecha_inicio()
  {
    var nomeCampo_fecha_inicio = "fecha_inicio";
    var var_fecha_inicio = scAjaxGetFieldText(nomeCampo_fecha_inicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_cursosxinstituciones_mob_validate_fecha_inicio(var_fecha_inicio, var_script_case_init, do_ajax_form_tb_cursosxinstituciones_mob_validate_fecha_inicio_cb);
  } // do_ajax_form_tb_cursosxinstituciones_mob_validate_fecha_inicio

  function do_ajax_form_tb_cursosxinstituciones_mob_validate_fecha_inicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_cursosxinstituciones_mob_validate_fecha_inicio_cb

  // ---------- Validate fecha_terminacion
  function do_ajax_form_tb_cursosxinstituciones_mob_validate_fecha_terminacion()
  {
    var nomeCampo_fecha_terminacion = "fecha_terminacion";
    var var_fecha_terminacion = scAjaxGetFieldText(nomeCampo_fecha_terminacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_cursosxinstituciones_mob_validate_fecha_terminacion(var_fecha_terminacion, var_script_case_init, do_ajax_form_tb_cursosxinstituciones_mob_validate_fecha_terminacion_cb);
  } // do_ajax_form_tb_cursosxinstituciones_mob_validate_fecha_terminacion

  function do_ajax_form_tb_cursosxinstituciones_mob_validate_fecha_terminacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_terminacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_cursosxinstituciones_mob_validate_fecha_terminacion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_cursosxinstituciones_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_cursosxinstituciones_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_institucion_id = scAjaxGetFieldSelect("institucion_id");
    var var_course_id = scAjaxGetFieldSelect("course_id");
    var var_estado_id = scAjaxGetFieldSelect("estado_id");
    var var_fecha_inicio = scAjaxGetFieldText("fecha_inicio");
    var var_fecha_terminacion = scAjaxGetFieldText("fecha_terminacion");
    var var_id_curxinst = scAjaxGetFieldText("id_curxinst");
    ...
    scAjaxProcOn();
    x_ajax_form_tb_cursosxinstituciones_mob_submit_form(var_institucion_id, var_course_id, var_estado_id, var_fecha_inicio, var_fecha_terminacion, var_id_curxinst, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_cursosxinstituciones_mob_submit_form_cb);
  } // do_ajax_form_tb_cursosxinstituciones_mob_submit_form

  function do_ajax_form_tb_cursosxinstituciones_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("institucion_id");
      scAjaxHideErrorDisplay("course_id");
      scAjaxHideErrorDisplay("estado_id");
      scAjaxHideErrorDisplay("fecha_inicio");
      scAjaxHideErrorDisplay("fecha_terminacion");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_cursosxinstituciones_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tb_cursosxinstituciones_mob_submit_form_cb
  function do_ajax_form_tb_cursosxinstituciones_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_cursosxinstituciones_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_cursosxinstituciones_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_cursosxinstituciones_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_cursosxinstituciones_mob_navigate_form();
    }
  }

  function perform_ajax_form_tb_cursosxinstituciones_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("fecha_inicio");
    scAjaxHideErrorDisplay("fecha_terminacion");
    var var_id_curxinst = document.F2.id_curxinst.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tb_cursosxinstituciones_mob_navigate_form(var_id_curxinst, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_cursosxinstituciones_mob_navigate_form_cb);
  } // do_ajax_form_tb_cursosxinstituciones_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_cursosxinstituciones_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_cursosxinstituciones_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_curxinst.value = scAjaxGetKeyValue("id_curxinst");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_cursosxinstituciones_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_cursosxinstituciones_mob_navigate_form_cb
  function do_ajax_form_tb_cursosxinstituciones_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tb_cursosxinstituciones_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_cursosxinstituciones_mob_navigate_form_cb_after_alert

  function sc_hide_form_tb_cursosxinstituciones_mob_form()
  {
  ...
  ajax_field_list[0] = "institucion_id";
  ajax_field_list[1] = "course_id";
  ajax_field_list[2] = "estado_id";
  ajax_field_list[3] = "fecha_inicio";
  ajax_field_list[4] = "fecha_terminacion";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "institucion_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_cursosxinstituciones_fld_Institucion_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "course_id": {"label": "Course", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "estado_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_cursosxinstituciones_fld_Estado_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "fecha_terminacion": {"label": "Fecha Terminacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "institucion_id": new Array(),
    "course_id": new Array(),
    "estado_id": new Array(),
    "fecha_inicio": new Array(),
    "fecha_terminacion": new Array()
  };
  ajax_field_mult["institucion_id"][1] = "institucion_id";
  ajax_field_mult["course_id"][1] = "course_id";
  ajax_field_mult["estado_id"][1] = "estado_id";
  ajax_field_mult["fecha_inicio"][1] = "fecha_inicio";
  ajax_field_mult["fecha_terminacion"][1] = "fecha_terminacion";

  var ajax_field_id = {
    "institucion_id": new Array("hidden_field_label_institucion_id", "hidden_field_data_institucion_id"),
    "course_id": new Array("hidden_field_label_course_id", "hidden_field_data_course_id"),
    "estado_id": new Array("hidden_field_label_estado_id", "hidden_field_data_estado_id"),
    "fecha_inicio": new Array("hidden_field_label_fecha_inicio", "hidden_field_data_fecha_inicio"),
    "fecha_terminacion": new Array("hidden_field_label_fecha_terminacion", "hidden_field_data_fecha_terminacion")
  };
