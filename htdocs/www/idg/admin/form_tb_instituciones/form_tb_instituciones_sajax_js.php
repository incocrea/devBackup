  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_instituciones" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_instituciones_form();
	}
...
?>
  ...
  // ---------- Validate nombre
  function do_ajax_form_tb_instituciones_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_instituciones_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_tb_instituciones_validate_nombre_cb);
  } // do_ajax_form_tb_instituciones_validate_nombre

  function do_ajax_form_tb_instituciones_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_instituciones_validate_nombre_cb

  // ---------- Validate telefono
  function do_ajax_form_tb_instituciones_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_instituciones_validate_telefono(var_telefono, var_script_case_init, do_ajax_form_tb_instituciones_validate_telefono_cb);
  } // do_ajax_form_tb_instituciones_validate_telefono

  function do_ajax_form_tb_instituciones_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_instituciones_validate_telefono_cb

  // ---------- Validate direccion
  function do_ajax_form_tb_instituciones_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_instituciones_validate_direccion(var_direccion, var_script_case_init, do_ajax_form_tb_instituciones_validate_direccion_cb);
  } // do_ajax_form_tb_instituciones_validate_direccion

  function do_ajax_form_tb_instituciones_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_instituciones_validate_direccion_cb

  // ---------- Validate email
  function do_ajax_form_tb_instituciones_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_instituciones_validate_email(var_email, var_script_case_init, do_ajax_form_tb_instituciones_validate_email_cb);
  } // do_ajax_form_tb_instituciones_validate_email

  function do_ajax_form_tb_instituciones_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_instituciones_validate_email_cb

  // ---------- Validate pais_id
  function do_ajax_form_tb_instituciones_validate_pais_id()
  {
    var nomeCampo_pais_id = "pais_id";
    var var_pais_id = scAjaxGetFieldSelect(nomeCampo_pais_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_instituciones_validate_pais_id(var_pais_id, var_script_case_init, do_ajax_form_tb_instituciones_validate_pais_id_cb);
  } // do_ajax_form_tb_instituciones_validate_pais_id

  function do_ajax_form_tb_instituciones_validate_pais_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pais_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_instituciones_validate_pais_id_cb

  // ---------- Validate activa
  function do_ajax_form_tb_instituciones_validate_activa()
  {
    var nomeCampo_activa = "activa";
    var var_activa = scAjaxGetFieldRadio(nomeCampo_activa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_instituciones_validate_activa(var_activa, var_script_case_init, do_ajax_form_tb_instituciones_validate_activa_cb);
  } // do_ajax_form_tb_instituciones_validate_activa

  function do_ajax_form_tb_instituciones_validate_activa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_instituciones_validate_activa_cb

  // ---------- Validate user_login
  function do_ajax_form_tb_instituciones_validate_user_login()
  {
    var nomeCampo_user_login = "user_login";
    var var_user_login = scAjaxGetFieldText(nomeCampo_user_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_instituciones_validate_user_login(var_user_login, var_script_case_init, do_ajax_form_tb_instituciones_validate_user_login_cb);
  } // do_ajax_form_tb_instituciones_validate_user_login

  function do_ajax_form_tb_instituciones_validate_user_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_instituciones_validate_user_login_cb

  // ---------- Validate password
  function do_ajax_form_tb_instituciones_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_instituciones_validate_password(var_password, var_script_case_init, do_ajax_form_tb_instituciones_validate_password_cb);
  } // do_ajax_form_tb_instituciones_validate_password

  function do_ajax_form_tb_instituciones_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_instituciones_validate_password_cb

  // ---------- Validate confirm_pass
  function do_ajax_form_tb_instituciones_validate_confirm_pass()
  {
    var nomeCampo_confirm_pass = "confirm_pass";
    var var_confirm_pass = scAjaxGetFieldText(nomeCampo_confirm_pass);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_instituciones_validate_confirm_pass(var_confirm_pass, var_script_case_init, do_ajax_form_tb_instituciones_validate_confirm_pass_cb);
  } // do_ajax_form_tb_instituciones_validate_confirm_pass

  function do_ajax_form_tb_instituciones_validate_confirm_pass_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_instituciones_validate_confirm_pass_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_instituciones_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_instituciones_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tb_instituciones_submit_form(var_nombre, var_telefono, var_direccion, var_email, var_pais_id, var_activa, var_user_login, var_password, var_confirm_pass, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_instituciones_submit_form_cb);
  } // do_ajax_form_tb_instituciones_submit_form

  function do_ajax_form_tb_instituciones_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_instituciones_submit_form_cb_after_alert);
  } // do_ajax_form_tb_instituciones_submit_form_cb
  function do_ajax_form_tb_instituciones_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_instituciones_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_instituciones_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_instituciones_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_instituciones_navigate_form();
    }
  }

  function perform_ajax_form_tb_instituciones_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tb_instituciones_navigate_form(var_id_institucion, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_instituciones_navigate_form_cb);
  } // do_ajax_form_tb_instituciones_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_instituciones']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_instituciones_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_instituciones_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_instituciones_navigate_form_cb
  function do_ajax_form_tb_instituciones_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tb_instituciones_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_instituciones_navigate_form_cb_after_alert

  function sc_hide_form_tb_instituciones_form()
  {
