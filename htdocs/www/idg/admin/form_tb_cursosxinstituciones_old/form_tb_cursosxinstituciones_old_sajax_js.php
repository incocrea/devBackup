  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_cursosxinstituciones_old" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_cursosxinstituciones_old_form();
	}
...
?>
  ...
  function do_ajax_form_tb_cursosxinstituciones_old_validate_institucion_id()
  {
    ...
    x_ajax_form_tb_cursosxinstituciones_old_validate_institucion_id(var_institucion_id, var_script_case_init, do_ajax_form_tb_cursosxinstituciones_old_validate_institucion_id_cb);
  } // do_ajax_form_tb_cursosxinstituciones_old_validate_institucion_id

  function do_ajax_form_tb_cursosxinstituciones_old_validate_institucion_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_cursosxinstituciones_old_validate_institucion_id_cb

  // ---------- Validate titulo
  function do_ajax_form_tb_cursosxinstituciones_old_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldText(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_cursosxinstituciones_old_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_tb_cursosxinstituciones_old_validate_titulo_cb);
  } // do_ajax_form_tb_cursosxinstituciones_old_validate_titulo

  function do_ajax_form_tb_cursosxinstituciones_old_validate_titulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "titulo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_cursosxinstituciones_old_validate_titulo_cb

  // ---------- Validate estado_id
  function do_ajax_form_tb_cursosxinstituciones_old_validate_estado_id()
  {
    var nomeCampo_estado_id = "estado_id";
    var var_estado_id = scAjaxGetFieldSelect(nomeCampo_estado_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_cursosxinstituciones_old_validate_estado_id(var_estado_id, var_script_case_init, do_ajax_form_tb_cursosxinstituciones_old_validate_estado_id_cb);
  } // do_ajax_form_tb_cursosxinstituciones_old_validate_estado_id

  function do_ajax_form_tb_cursosxinstituciones_old_validate_estado_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_cursosxinstituciones_old_validate_estado_id_cb

  // ---------- Validate fecha_inicio
  function do_ajax_form_tb_cursosxinstituciones_old_validate_fecha_inicio()
  {
    var nomeCampo_fecha_inicio = "fecha_inicio";
    var var_fecha_inicio = scAjaxGetFieldText(nomeCampo_fecha_inicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_cursosxinstituciones_old_validate_fecha_inicio(var_fecha_inicio, var_script_case_init, do_ajax_form_tb_cursosxinstituciones_old_validate_fecha_inicio_cb);
  } // do_ajax_form_tb_cursosxinstituciones_old_validate_fecha_inicio

  function do_ajax_form_tb_cursosxinstituciones_old_validate_fecha_inicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_cursosxinstituciones_old_validate_fecha_inicio_cb

  // ---------- Validate fecha_terminacion
  function do_ajax_form_tb_cursosxinstituciones_old_validate_fecha_terminacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_cursosxinstituciones_old_validate_fecha_terminacion(var_fecha_terminacion, var_script_case_init, do_ajax_form_tb_cursosxinstituciones_old_validate_fecha_terminacion_cb);
  } // do_ajax_form_tb_cursosxinstituciones_old_validate_fecha_terminacion

  function do_ajax_form_tb_cursosxinstituciones_old_validate_fecha_terminacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_cursosxinstituciones_old_validate_fecha_terminacion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_cursosxinstituciones_old_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_cursosxinstituciones_old_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tb_cursosxinstituciones_old_submit_form(var_institucion_id, var_titulo, var_estado_id, var_fecha_inicio, var_fecha_terminacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_cursosxinstituciones_old_submit_form_cb);
  } // do_ajax_form_tb_cursosxinstituciones_old_submit_form

  function do_ajax_form_tb_cursosxinstituciones_old_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_cursosxinstituciones_old_submit_form_cb_after_alert);
  } // do_ajax_form_tb_cursosxinstituciones_old_submit_form_cb
  function do_ajax_form_tb_cursosxinstituciones_old_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_cursosxinstituciones_old_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_cursosxinstituciones_old_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_cursosxinstituciones_old_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_cursosxinstituciones_old_navigate_form();
    }
  }

  function perform_ajax_form_tb_cursosxinstituciones_old_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tb_cursosxinstituciones_old_navigate_form(var_id_curxinst, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_cursosxinstituciones_old_navigate_form_cb);
  } // do_ajax_form_tb_cursosxinstituciones_old_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_cursosxinstituciones_old']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_cursosxinstituciones_old_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_cursosxinstituciones_old_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_cursosxinstituciones_old_navigate_form_cb
  function do_ajax_form_tb_cursosxinstituciones_old_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tb_cursosxinstituciones_old_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_cursosxinstituciones_old_navigate_form_cb_after_alert

  function sc_hide_form_tb_cursosxinstituciones_old_form()
  {
