<?php
   include_once('blank_importar_alumnos_excel_seg1_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class blank_importar_alumnos_excel_seg1_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "blank_importar_alumnos_excel_seg1"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_hr_criacao   = "193146"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20221102"; 
      $this->nm_hr_ult_alt   = "182930"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['sub_cons_schema_filter'];
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/blank_importar_alumnos_excel_seg1';
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['actual_lang']) || $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("blank_importar_alumnos_excel_seg1_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_importar_alumnos_excel_seg1"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_importar_alumnos_excel_seg1"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['blank_importar_alumnos_excel_seg1']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['blank_importar_alumnos_excel_seg1']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['blank_importar_alumnos_excel_seg1']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "blank_importar_alumnos_excel_seg1_erro.class.php"); 
      $this->Erro = new blank_importar_alumnos_excel_seg1_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('blank_importar_alumnos_excel_seg1'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_conexao']) && $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_perfil']) && $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_conexao'], $this->root . $this->path_prod, 'vrcrenewable', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           $delim  = "'";
           $delim1 = "'";
           if (isset($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_importar_alumnos_excel_seg1']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class blank_importar_alumnos_excel_seg1_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new blank_importar_alumnos_excel_seg1_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['blank_importar_alumnos_excel_seg1']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['blank_importar_alumnos_excel_seg1']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_importar_alumnos_excel_seg1']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_importar_alumnos_excel_seg1'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_importar_alumnos_excel_seg1']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_importar_alumnos_excel_seg1']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('blank_importar_alumnos_excel_seg1') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_importar_alumnos_excel_seg1']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "blank_importar_alumnos_excel_seg1")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['blank_importar_alumnos_excel_seg1']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['blank_importar_alumnos_excel_seg1']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['blank_importar_alumnos_excel_seg1']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "blank_importar_alumnos_excel_seg1_erro.class.php"); 
      $this->Erro      = new blank_importar_alumnos_excel_seg1_erro();
...
//
      ...
      $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['contr_erro'] = 'on';
...
if (!isset($this->sc_temp_user_login)) {$this->sc_temp_user_login = (isset($_SESSION['user_login'])) ? $_SESSION['user_login'] : "";}
 

$check_sql = "SELECT Id_institucion, Pais_id"
   . " FROM tb_instituciones"
   . " WHERE user_login = '" . $this->sc_temp_user_login . "'";
...
$check_sql = "SELECT COUNT(*) FROM tb_clientes";
...
if (strpos(strtolower($this->Ini->nm_tpbanco), "access") === false && !$this->Ini->sc_tem_trans_banco)
{
	...
	for ($row=2;$row<= $highestRow; ++ $row){        
		...
		$num_doc = $cell ->getValue(); 
		$cell = $worksheet -> getCellByColumnAndRow (2, $row);
		$nombre_completo = $cell ->getValue(); 
...
$login = $email;		
		...
		if (empty($num_doc)) {
			$this->nm_mens_alert[] = "El campo Número de documento, esta vacio en la celda: B".$row.", Se debe corregir celda indicada.";$this->nm_params_alert[] = array();break;
		} elseif (empty($nombre_completo)) {
			$this->nm_mens_alert[] = "El campo nombre_completo esta vacio en la celda: C".$row.", Se debe corregir celda indicada.";$this->nm_params_alert[] = array();break;
		} elseif (empty($telefono)) {
			$this->nm_mens_alert[] = "El campo Teléfono esta vacio en la celda: D".$row.", Se debe corregir celda indicada.";$this->nm_params_alert[] = array();break;
		} elseif (empty($direccion)) {
			$this->nm_mens_alert[] = "El campo dirección esta vacio en la celda: E".$row.", Se debe corregir celda indicada.";$this->nm_params_alert[] = array();break;
		} elseif (empty($email)) {
			$this->nm_mens_alert[] = "El campo email esta vacio en la celda: F".$row.", Se debe corregir celda indicada.";$this->nm_params_alert[] = array();break;
		} else { 
			...
			$insert_sql = "INSERT INTO tb_clientes (Cliente_num_doc, Cliente_nombre, Cliente_telefono, Cliente_direccion, Cliente_email, Pais_id, Docxpais_id) SELECT * FROM (SELECT '$num_doc', '$nombre_completo' , '$telefono', '$direccion', '$email', ' $id_pais') AS temp					 
					 WHERE NOT EXISTS(SELECT Cliente_num_doc FROM tb_clientes WHERE Cliente_num_doc = '$num_doc' )"; 
		...
		else     
{
		   echo  '';
			...
			$sql_insert ="INSERT INTO sec_users (login, pswd, name, active, priv_admin, mfa) SELECT * FROM ( SELECT '$email', '$num_doc', '$nombre_completo', 'Y','N','Estudiante') AS temp
				WHERE NOT EXISTS(SELECT login FROM sec_users WHERE login = '$email' )";
     ...
     $nm_select = $sql_insert; 
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         ...
         $rf->Close();
			...
			$sql_insert_group ="INSERT INTO sec_users_groups (login, group_id) SELECT * FROM ( SELECT '$email', '2')AS temp
			WHERE NOT EXISTS(SELECT login FROM sec_users_groups WHERE login = '$email' )"; 			 
			
     $nm_select = $sql_insert_group; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
	...
	if ($this->Ini->sc_tem_trans_banco)
{
	...
	$this->nm_mens_alert[] = "¡Archivo procesado correctamente! Total de Registros procesados: $Total";$this->nm_params_alert[] = array();} else {
	if ($this->Ini->sc_tem_trans_banco)
{
    $this->Db->RollbackTrans();
    $this->Ini->sc_tem_trans_banco = false;
...
if (isset($this->sc_temp_user_login)) {$_SESSION['user_login'] = $this->sc_temp_user_login;}
if (isset($this->sc_temp_ubicacion)) {$_SESSION['ubicacion'] = $this->sc_temp_ubicacion;}
$_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['contr_erro'] = 'off'; 
$confirmButtonClass = '';
$cancelButtonClass  = '';
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
<script type="text/javascript" src="../_lib/lib/js/frameControl.js"></script>

<script type="text/javascript" src="blank_importar_alumnos_excel_seg1_message.js"></script>
<script type="text/javascript">
$(function() {
<?php
if (count($this->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['blank_importar_alumnos_excel_seg1']['ajax_nav'])
           { 
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_blank_importar_alumnos_excel_seg1($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blank_importar_alumnos_excel_seg1") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_vrcrenewable'])) {
               $_SESSION['scriptcase']['blank_importar_alumnos_excel_seg1']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_vrcrenewable'];
           }
       }
   }
   ...
   if (isset($_POST["ubicacion"])) 
   {
       ...
       nm_limpa_str_blank_importar_alumnos_excel_seg1($_SESSION["ubicacion"]);
   }
   ...
   if (isset($_POST["user_login"])) 
   {
       ...
       nm_limpa_str_blank_importar_alumnos_excel_seg1($_SESSION["user_login"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['blank_importar_alumnos_excel_seg1']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['blank_importar_alumnos_excel_seg1']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['blank_importar_alumnos_excel_seg1']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "blank_importar_alumnos_excel_seg1";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'blank_importar_alumnos_excel_seg1' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['blank_importar_alumnos_excel_seg1']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['blank_importar_alumnos_excel_seg1']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['blank_importar_alumnos_excel_seg1']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_importar_alumnos_excel_seg1']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_importar_alumnos_excel_seg1']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('blank_importar_alumnos_excel_seg1' == $sReferer || 'blank_importar_alumnos_excel_seg1_' == substr($sReferer, 0, 34))
       {
           $_SESSION['sc_session'][$script_case_init]['blank_importar_alumnos_excel_seg1']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'blank_importar_alumnos_excel_seg1')
   {
       $_SESSION['sc_session'][$script_case_init]['blank_importar_alumnos_excel_seg1']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['blank_importar_alumnos_excel_seg1']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/blank_importar_alumnos_excel_seg1_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_blank_importar_alumnos_excel_seg1($cadapar[1]);
   ...
   $contr_blank_importar_alumnos_excel_seg1 = new blank_importar_alumnos_excel_seg1_apl();
   $contr_blank_importar_alumnos_excel_seg1->controle();
//
   function nm_limpa_str_blank_importar_alumnos_excel_seg1(&$str)
   {
   }
?>
