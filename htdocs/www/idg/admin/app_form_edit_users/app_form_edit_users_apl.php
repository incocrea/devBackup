...
//
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['dados_select']['mfa']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->mfa = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['dados_select']['mfa'];
          } 
      }
...
$aLookup[] = array(app_form_edit_users_pack_protect_string('Administrador') => str_replace('<', '&lt;',app_form_edit_users_pack_protect_string("Administrador")));
$aLookup[] = array(app_form_edit_users_pack_protect_string('Estudiante') => str_replace('<', '&lt;',app_form_edit_users_pack_protect_string("Estudiante")));
$aLookup[] = array(app_form_edit_users_pack_protect_string('Empresa') => str_replace('<', '&lt;',app_form_edit_users_pack_protect_string("Empresa")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['Lookup_mfa'][] = 'Administrador';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['Lookup_mfa'][] = 'Estudiante';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['Lookup_mfa'][] = 'Empresa';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"mfa\"";
          ...
          {
              $this->NM_ajax_info['fldList']['mfa']['valList'][$i] = app_form_edit_users_pack_protect_string($v);
          }
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
             ...
             { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('login', 'pswd', 'confirm_pswd', 'name', 'email', 'mfa', 'active', 'groups'), $aDoNotUpdate);
              $this->ajax_return_values();
