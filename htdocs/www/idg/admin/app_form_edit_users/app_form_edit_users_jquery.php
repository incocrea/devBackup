...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["mfa" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["mfa" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_mfa' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_mfa_onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_app_form_edit_users_mfa_onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_app_form_edit_users_mfa_onfocus(this, iSeqRow) });
...
function sc_app_form_edit_users_mfa_onblur(oThis, iSeqRow) {
...
function sc_app_form_edit_users_mfa_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
