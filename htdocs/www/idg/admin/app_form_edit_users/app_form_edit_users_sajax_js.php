...
?>
  ...
  // ---------- Validate mfa
  function do_ajax_app_form_edit_users_validate_mfa()
  {
    var nomeCampo_mfa = "mfa";
    var var_mfa = scAjaxGetFieldSelect(nomeCampo_mfa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_validate_mfa(var_mfa, var_script_case_init, do_ajax_app_form_edit_users_validate_mfa_cb);
  } // do_ajax_app_form_edit_users_validate_mfa

  function do_ajax_app_form_edit_users_validate_mfa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mfa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_validate_mfa_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_form_edit_users_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_edit_users_submit_form(var_picture, var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_mfa, var_active, var_groups, var_picture_ul_name, var_picture_ul_type, var_picture_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_edit_users_submit_form_cb);
