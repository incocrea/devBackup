  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_certificados" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_certificados_form();
	}
...
?>
  ...
  function do_ajax_form_tb_certificados_validate_curxinst_id()
  {
    var nomeCampo_curxinst_id = "curxinst_id";
    var var_curxinst_id = scAjaxGetFieldSelect(nomeCampo_curxinst_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_certificados_validate_curxinst_id(var_curxinst_id, var_script_case_init, do_ajax_form_tb_certificados_validate_curxinst_id_cb);
  } // do_ajax_form_tb_certificados_validate_curxinst_id

  function do_ajax_form_tb_certificados_validate_curxinst_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_certificados_validate_curxinst_id_cb

  // ---------- Validate informacion
  function do_ajax_form_tb_certificados_validate_informacion()
  {
    var nomeCampo_informacion = "informacion";
    var var_informacion = scAjaxGetFieldEditorHtml(nomeCampo_informacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_certificados_validate_informacion(var_informacion, var_script_case_init, do_ajax_form_tb_certificados_validate_informacion_cb);
  } // do_ajax_form_tb_certificados_validate_informacion

  function do_ajax_form_tb_certificados_validate_informacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_certificados_validate_informacion_cb

  // ---------- Validate activo
  function do_ajax_form_tb_certificados_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldText(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_certificados_validate_activo(var_activo, var_script_case_init, do_ajax_form_tb_certificados_validate_activo_cb);
  } // do_ajax_form_tb_certificados_validate_activo

  function do_ajax_form_tb_certificados_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_certificados_validate_activo_cb

  // ---------- Validate modalidad
  function do_ajax_form_tb_certificados_validate_modalidad()
  {
    var nomeCampo_modalidad = "modalidad";
    var var_modalidad = scAjaxGetFieldText(nomeCampo_modalidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_certificados_validate_modalidad(var_modalidad, var_script_case_init, do_ajax_form_tb_certificados_validate_modalidad_cb);
  } // do_ajax_form_tb_certificados_validate_modalidad

  function do_ajax_form_tb_certificados_validate_modalidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_certificados_validate_modalidad_cb

  // ---------- Validate enlace_imagen
  function do_ajax_form_tb_certificados_validate_enlace_imagen()
  {
    var nomeCampo_enlace_imagen = "enlace_imagen";
    var var_enlace_imagen = scAjaxGetFieldText(nomeCampo_enlace_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_certificados_validate_enlace_imagen(var_enlace_imagen, var_script_case_init, do_ajax_form_tb_certificados_validate_enlace_imagen_cb);
  } // do_ajax_form_tb_certificados_validate_enlace_imagen

  function do_ajax_form_tb_certificados_validate_enlace_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_certificados_validate_enlace_imagen_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_certificados_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_certificados_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tb_certificados_submit_form(var_curxinst_id, var_informacion, var_activo, var_modalidad, var_enlace_imagen, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_certificados_submit_form_cb);
  } // do_ajax_form_tb_certificados_submit_form

  function do_ajax_form_tb_certificados_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_certificados_submit_form_cb_after_alert);
  } // do_ajax_form_tb_certificados_submit_form_cb
  function do_ajax_form_tb_certificados_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_certificados_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_certificados_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_certificados_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_certificados_navigate_form();
    }
  }

  function perform_ajax_form_tb_certificados_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tb_certificados_navigate_form(var_id_certificado, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_certificados_navigate_form_cb);
  } // do_ajax_form_tb_certificados_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_certificados']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_certificados_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_certificados_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_certificados_navigate_form_cb
  function do_ajax_form_tb_certificados_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tb_certificados_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_certificados_navigate_form_cb_after_alert

  function sc_hide_form_tb_certificados_form()
  {
