  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_certificados_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_certificados_mob_form();
	}
...
?>
  ...
  // ---------- Validate curxinst_id
  function do_ajax_form_tb_certificados_mob_validate_curxinst_id()
  {
    var nomeCampo_curxinst_id = "curxinst_id";
    var var_curxinst_id = scAjaxGetFieldSelect(nomeCampo_curxinst_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_certificados_mob_validate_curxinst_id(var_curxinst_id, var_script_case_init, do_ajax_form_tb_certificados_mob_validate_curxinst_id_cb);
  } // do_ajax_form_tb_certificados_mob_validate_curxinst_id

  function do_ajax_form_tb_certificados_mob_validate_curxinst_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "curxinst_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_certificados_mob_validate_curxinst_id_cb

  // ---------- Validate informacion
  function do_ajax_form_tb_certificados_mob_validate_informacion()
  {
    var nomeCampo_informacion = "informacion";
    var var_informacion = scAjaxGetFieldEditorHtml(nomeCampo_informacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_certificados_mob_validate_informacion(var_informacion, var_script_case_init, do_ajax_form_tb_certificados_mob_validate_informacion_cb);
  } // do_ajax_form_tb_certificados_mob_validate_informacion

  function do_ajax_form_tb_certificados_mob_validate_informacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "informacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_certificados_mob_validate_informacion_cb

  // ---------- Validate activo
  function do_ajax_form_tb_certificados_mob_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldText(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_certificados_mob_validate_activo(var_activo, var_script_case_init, do_ajax_form_tb_certificados_mob_validate_activo_cb);
  } // do_ajax_form_tb_certificados_mob_validate_activo

  function do_ajax_form_tb_certificados_mob_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_certificados_mob_validate_activo_cb

  // ---------- Validate modalidad
  function do_ajax_form_tb_certificados_mob_validate_modalidad()
  {
    var nomeCampo_modalidad = "modalidad";
    var var_modalidad = scAjaxGetFieldText(nomeCampo_modalidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_certificados_mob_validate_modalidad(var_modalidad, var_script_case_init, do_ajax_form_tb_certificados_mob_validate_modalidad_cb);
  } // do_ajax_form_tb_certificados_mob_validate_modalidad

  function do_ajax_form_tb_certificados_mob_validate_modalidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_certificados_mob_validate_modalidad_cb

  // ---------- Validate enlace_imagen
  function do_ajax_form_tb_certificados_mob_validate_enlace_imagen()
  {
    var nomeCampo_enlace_imagen = "enlace_imagen";
    var var_enlace_imagen = scAjaxGetFieldText(nomeCampo_enlace_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_certificados_mob_validate_enlace_imagen(var_enlace_imagen, var_script_case_init, do_ajax_form_tb_certificados_mob_validate_enlace_imagen_cb);
  } // do_ajax_form_tb_certificados_mob_validate_enlace_imagen

  function do_ajax_form_tb_certificados_mob_validate_enlace_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "enlace_imagen";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_certificados_mob_validate_enlace_imagen_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_certificados_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_certificados_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_curxinst_id = scAjaxGetFieldSelect("curxinst_id");
    var var_informacion = scAjaxGetFieldEditorHtml("informacion");
    var var_activo = scAjaxGetFieldText("activo");
    var var_modalidad = scAjaxGetFieldText("modalidad");
    var var_enlace_imagen = scAjaxGetFieldText("enlace_imagen");
    var var_id_certificado = scAjaxGetFieldText("id_certificado");
    ...
    scAjaxProcOn();
    x_ajax_form_tb_certificados_mob_submit_form(var_curxinst_id, var_informacion, var_activo, var_modalidad, var_enlace_imagen, var_id_certificado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_certificados_mob_submit_form_cb);
  } // do_ajax_form_tb_certificados_mob_submit_form

  function do_ajax_form_tb_certificados_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("curxinst_id");
      scAjaxHideErrorDisplay("informacion");
      scAjaxHideErrorDisplay("activo");
      scAjaxHideErrorDisplay("modalidad");
      scAjaxHideErrorDisplay("enlace_imagen");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_certificados_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tb_certificados_mob_submit_form_cb
  function do_ajax_form_tb_certificados_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_certificados_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_certificados_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_certificados_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_certificados_mob_navigate_form();
    }
  }

  function perform_ajax_form_tb_certificados_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("modalidad");
    scAjaxHideErrorDisplay("enlace_imagen");
    var var_id_certificado = document.F2.id_certificado.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tb_certificados_mob_navigate_form(var_id_certificado, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_certificados_mob_navigate_form_cb);
  } // do_ajax_form_tb_certificados_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_certificados_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_certificados_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_certificado.value = scAjaxGetKeyValue("id_certificado");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_certificados_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_certificados_mob_navigate_form_cb
  function do_ajax_form_tb_certificados_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tb_certificados_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_certificados_mob_navigate_form_cb_after_alert

  function sc_hide_form_tb_certificados_mob_form()
  {
  ...
  ajax_field_list[0] = "curxinst_id";
  ajax_field_list[1] = "informacion";
  ajax_field_list[2] = "activo";
  ajax_field_list[3] = "modalidad";
  ajax_field_list[4] = "enlace_imagen";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "curxinst_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_certificados_fld_Curxinst_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "informacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_certificados_fld_Informacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "activo": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_certificados_fld_Activo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "modalidad": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_certificados_fld_Modalidad'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "enlace_imagen": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_certificados_fld_Enlace_imagen'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "curxinst_id": new Array(),
    "informacion": new Array(),
    "activo": new Array(),
    "modalidad": new Array(),
    "enlace_imagen": new Array()
  };
  ajax_field_mult["curxinst_id"][1] = "curxinst_id";
  ajax_field_mult["informacion"][1] = "informacion";
  ajax_field_mult["activo"][1] = "activo";
  ajax_field_mult["modalidad"][1] = "modalidad";
  ajax_field_mult["enlace_imagen"][1] = "enlace_imagen";

  var ajax_field_id = {
    "curxinst_id": new Array("hidden_field_label_curxinst_id", "hidden_field_data_curxinst_id"),
    "informacion": new Array("hidden_field_label_informacion", "hidden_field_data_informacion"),
    ...
    "enlace_imagen": new Array("hidden_field_label_enlace_imagen", "hidden_field_data_enlace_imagen")
  };
