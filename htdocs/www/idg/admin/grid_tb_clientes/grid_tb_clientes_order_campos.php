<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tb_clientes']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tb_clientes_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tb_clientes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['cliente_nombre'] = "on";
   $tab_def_campos['cliente_nombre'] = "Cliente_nombre";
   $tab_labels["cliente_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['labels']["cliente_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['labels']["cliente_nombre"] : "" . $this->Nm_lang['lang_tb_clientes_fld_Cliente_nombre'] . "";
   $tab_ger_campos['docxpais_id'] = "on";
   $tab_def_campos['docxpais_id'] = "Docxpais_id";
   $tab_labels["docxpais_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['labels']["docxpais_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['labels']["docxpais_id"] : "" . $this->Nm_lang['lang_tb_clientes_fld_Docxpais_id'] . "";
   $tab_ger_campos['cliente_num_doc'] = "on";
   $tab_def_campos['cliente_num_doc'] = "Cliente_num_doc";
   $tab_labels["cliente_num_doc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['labels']["cliente_num_doc"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['labels']["cliente_num_doc"] : "" . $this->Nm_lang['lang_tb_clientes_fld_Cliente_num_doc'] . "";
   $tab_ger_campos['cliente_telefono'] = "on";
   $tab_def_campos['cliente_telefono'] = "Cliente_telefono";
   $tab_labels["cliente_telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['labels']["cliente_telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['labels']["cliente_telefono"] : "" . $this->Nm_lang['lang_tb_clientes_fld_Cliente_telefono'] . "";
   $tab_ger_campos['cliente_direccion'] = "on";
   $tab_def_campos['cliente_direccion'] = "Cliente_direccion";
   $tab_labels["cliente_direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['labels']["cliente_direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['labels']["cliente_direccion"] : "" . $this->Nm_lang['lang_tb_clientes_fld_Cliente_direccion'] . "";
   $tab_ger_campos['cliente_email'] = "on";
   $tab_def_campos['cliente_email'] = "Cliente_email";
   $tab_labels["cliente_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['labels']["cliente_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['labels']["cliente_email"] : "" . $this->Nm_lang['lang_tb_clientes_fld_Cliente_email'] . "";
   $tab_ger_campos['pais_id'] = "on";
   $tab_def_campos['pais_id'] = "Pais_id";
   $tab_labels["pais_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['labels']["pais_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['labels']["pais_id"] : "" . $this->Nm_lang['lang_tb_clientes_fld_Pais_id'] . "";
   $tab_ger_campos['users_login'] = "on";
   $tab_def_campos['users_login'] = "users_login";
   $tab_labels["users_login"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['labels']["users_login"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['labels']["users_login"] : "" . $this->Nm_lang['lang_tb_clientes_fld_users_login'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tb_clientes_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tb_clientes']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
