...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["vrcrenewable_____grid_tb_clientes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["vrcrenewable_____grid_tb_clientes"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tb_clientes'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tb_clientes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tb_clientes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tb_clientes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tb_clientes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tb_clientes']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tb_clientes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tb_clientes']['embutida_filho'] as $ind => $sc_init)
          {
