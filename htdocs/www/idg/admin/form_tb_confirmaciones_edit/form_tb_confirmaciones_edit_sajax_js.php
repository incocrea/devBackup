  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_confirmaciones_edit" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_confirmaciones_edit_form();
	}
...
?>
  ...
  function do_ajax_form_tb_confirmaciones_edit_validate_codigoverificacion()
  {
    ...
    x_ajax_form_tb_confirmaciones_edit_validate_codigoverificacion(var_codigoverificacion, var_script_case_init, do_ajax_form_tb_confirmaciones_edit_validate_codigoverificacion_cb);
  } // do_ajax_form_tb_confirmaciones_edit_validate_codigoverificacion

  function do_ajax_form_tb_confirmaciones_edit_validate_codigoverificacion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_confirmaciones_edit_validate_codigoverificacion_cb

  // ---------- Validate clixcur_id
  function do_ajax_form_tb_confirmaciones_edit_validate_clixcur_id()
  {
    var nomeCampo_clixcur_id = "clixcur_id";
    var var_clixcur_id = scAjaxGetFieldSelect(nomeCampo_clixcur_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_confirmaciones_edit_validate_clixcur_id(var_clixcur_id, var_script_case_init, do_ajax_form_tb_confirmaciones_edit_validate_clixcur_id_cb);
  } // do_ajax_form_tb_confirmaciones_edit_validate_clixcur_id

  function do_ajax_form_tb_confirmaciones_edit_validate_clixcur_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_confirmaciones_edit_validate_clixcur_id_cb

  // ---------- Validate url
  function do_ajax_form_tb_confirmaciones_edit_validate_url()
  {
    var nomeCampo_url = "url";
    var var_url = scAjaxGetFieldText(nomeCampo_url);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_confirmaciones_edit_validate_url(var_url, var_script_case_init, do_ajax_form_tb_confirmaciones_edit_validate_url_cb);
  } // do_ajax_form_tb_confirmaciones_edit_validate_url

  function do_ajax_form_tb_confirmaciones_edit_validate_url_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "url";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_confirmaciones_edit_validate_url_cb

  // ---------- Validate activo
  function do_ajax_form_tb_confirmaciones_edit_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldCheckbox(nomeCampo_activo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_confirmaciones_edit_validate_activo(var_activo, var_script_case_init, do_ajax_form_tb_confirmaciones_edit_validate_activo_cb);
  } // do_ajax_form_tb_confirmaciones_edit_validate_activo

  function do_ajax_form_tb_confirmaciones_edit_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_confirmaciones_edit_validate_activo_cb

  // ---------- Event onchange clixcur_id
  function do_ajax_form_tb_confirmaciones_edit_event_clixcur_id_onchange()
  {
    var var_url = scAjaxGetFieldText("url");
    var var_clixcur_id = scAjaxGetFieldSelect("clixcur_id");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tb_confirmaciones_edit_event_clixcur_id_onchange(var_url, var_clixcur_id, var_script_case_init, do_ajax_form_tb_confirmaciones_edit_event_clixcur_id_onchange_cb);
  } // do_ajax_form_tb_confirmaciones_edit_event_clixcur_id_onchange

  function do_ajax_form_tb_confirmaciones_edit_event_clixcur_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "clixcur_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tb_confirmaciones_edit_event_clixcur_id_onchange_cb_after_alert);
  } // do_ajax_form_tb_confirmaciones_edit_event_clixcur_id_onchange_cb
  function do_ajax_form_tb_confirmaciones_edit_event_clixcur_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tb_confirmaciones_edit_event_clixcur_id_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_confirmaciones_edit_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_confirmaciones_edit_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tb_confirmaciones_edit_submit_form(var_codigoverificacion, var_clixcur_id, var_url, var_activo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_confirmaciones_edit_submit_form_cb);
  } // do_ajax_form_tb_confirmaciones_edit_submit_form

  function do_ajax_form_tb_confirmaciones_edit_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_confirmaciones_edit_submit_form_cb_after_alert);
  } // do_ajax_form_tb_confirmaciones_edit_submit_form_cb
  function do_ajax_form_tb_confirmaciones_edit_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_confirmaciones_edit_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_confirmaciones_edit_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_confirmaciones_edit_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_confirmaciones_edit_navigate_form();
    }
  }

  function perform_ajax_form_tb_confirmaciones_edit_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tb_confirmaciones_edit_navigate_form(var_confirmacion_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_confirmaciones_edit_navigate_form_cb);
  } // do_ajax_form_tb_confirmaciones_edit_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_confirmaciones_edit']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_confirmaciones_edit_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_confirmaciones_edit_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_confirmaciones_edit_navigate_form_cb
  function do_ajax_form_tb_confirmaciones_edit_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tb_confirmaciones_edit_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_confirmaciones_edit_navigate_form_cb_after_alert

  function sc_hide_form_tb_confirmaciones_edit_form()
  {
