<?php
@session_start() ;
$_SESSION['scriptcase']['grid_empresa_alumnos_curso']['sc_process_barr'] = true;
require_once('../grid_empresa_alumnos_curso/index.php');
unset($_SESSION['scriptcase']['grid_empresa_alumnos_curso']['sc_process_barr']);
$ExportCtrl = new grid_empresa_alumnos_curso_export_control;
$ExportCtrl->Export_barr();

class grid_empresa_alumnos_curso_export_control
{
