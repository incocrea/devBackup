...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["vrcrenewable_____grid_empresa_alumnos_curso"]))
   {
      unset($_SESSION['session_sec_aplicacao']["vrcrenewable_____grid_empresa_alumnos_curso"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_empresa_alumnos_curso']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_empresa_alumnos_curso']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_empresa_alumnos_curso']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_empresa_alumnos_curso']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_empresa_alumnos_curso']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_empresa_alumnos_curso</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_empresa_alumnos_curso']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_empresa_alumnos_curso']['embutida_filho'] as $ind => $sc_init)
          {
