<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_empresa_alumnos_curso']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_empresa_alumnos_curso_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_empresa_alumnos_curso_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['tb_clientes_cliente_num_doc'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_clientes_cliente_num_doc'] = "tb_clientes_cliente_num_doc";
   }
   else
   {
       $tab_def_campos['tb_clientes_cliente_num_doc'] = "tb_clientes.Cliente_num_doc";
   }
   $tab_labels["tb_clientes_cliente_num_doc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['labels']["tb_clientes_cliente_num_doc"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['labels']["tb_clientes_cliente_num_doc"] : "Cliente Num Doc";
   $tab_ger_campos['tb_clientesxcursos_estado_id'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_clientesxcursos_estado_id'] = "tb_clientesxcursos_estado_id";
   }
   else
   {
       $tab_def_campos['tb_clientesxcursos_estado_id'] = "tb_clientesxcursos.Estado_id";
   }
   $tab_labels["tb_clientesxcursos_estado_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['labels']["tb_clientesxcursos_estado_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['labels']["tb_clientesxcursos_estado_id"] : "Estado Id";
   $tab_ger_campos['tb_clientes_cliente_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_clientes_cliente_nombre'] = "tb_clientes_cliente_nombre";
   }
   else
   {
       $tab_def_campos['tb_clientes_cliente_nombre'] = "tb_clientes.Cliente_nombre";
   }
   $tab_labels["tb_clientes_cliente_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['labels']["tb_clientes_cliente_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['labels']["tb_clientes_cliente_nombre"] : "Cliente Nombre";
   $tab_ger_campos['tb_clientes_cliente_telefono'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_clientes_cliente_telefono'] = "tb_clientes_cliente_telefono";
   }
   else
   {
       $tab_def_campos['tb_clientes_cliente_telefono'] = "tb_clientes.Cliente_telefono";
   }
   $tab_labels["tb_clientes_cliente_telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['labels']["tb_clientes_cliente_telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['labels']["tb_clientes_cliente_telefono"] : "Cliente Telefono";
   $tab_ger_campos['tb_clientes_cliente_direccion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_clientes_cliente_direccion'] = "tb_clientes_cliente_direccion";
   }
   else
   {
       $tab_def_campos['tb_clientes_cliente_direccion'] = "tb_clientes.Cliente_direccion";
   }
   $tab_labels["tb_clientes_cliente_direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['labels']["tb_clientes_cliente_direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['labels']["tb_clientes_cliente_direccion"] : "Cliente Direccion";
   $tab_ger_campos['tb_clientes_cliente_email'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_clientes_cliente_email'] = "tb_clientes_cliente_email";
   }
   else
   {
       $tab_def_campos['tb_clientes_cliente_email'] = "tb_clientes.Cliente_email";
   }
   $tab_labels["tb_clientes_cliente_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['labels']["tb_clientes_cliente_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['labels']["tb_clientes_cliente_email"] : "Cliente Email";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> empresa_alumnos_curso</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_empresa_alumnos_curso_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_empresa_alumnos_curso']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
