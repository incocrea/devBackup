  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_clientes" == sTestField)
        {
...
?>
  ...
  // ---------- Validate pais_id
  function do_ajax_form_tb_clientes_validate_pais_id()
  {
  } // do_ajax_form_tb_clientes_validate_pais_id

  function do_ajax_form_tb_clientes_validate_pais_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_validate_pais_id_cb

  // ---------- Validate docxpais_id
  function do_ajax_form_tb_clientes_validate_docxpais_id()
  {
    var nomeCampo_docxpais_id = "docxpais_id";
    var var_docxpais_id = scAjaxGetFieldSelect(nomeCampo_docxpais_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_validate_docxpais_id(var_docxpais_id, var_script_case_init, do_ajax_form_tb_clientes_validate_docxpais_id_cb);
  } // do_ajax_form_tb_clientes_validate_docxpais_id

  function do_ajax_form_tb_clientes_validate_docxpais_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "docxpais_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_validate_docxpais_id_cb

  // ---------- Validate cliente_num_doc
  function do_ajax_form_tb_clientes_validate_cliente_num_doc()
  {
    var nomeCampo_cliente_num_doc = "cliente_num_doc";
    var var_cliente_num_doc = scAjaxGetFieldText(nomeCampo_cliente_num_doc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_validate_cliente_num_doc(var_cliente_num_doc, var_script_case_init, do_ajax_form_tb_clientes_validate_cliente_num_doc_cb);
  } // do_ajax_form_tb_clientes_validate_cliente_num_doc

  function do_ajax_form_tb_clientes_validate_cliente_num_doc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente_num_doc";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_validate_cliente_num_doc_cb

  // ---------- Validate cliente_nombre
  function do_ajax_form_tb_clientes_validate_cliente_nombre()
  {
    var nomeCampo_cliente_nombre = "cliente_nombre";
    var var_cliente_nombre = scAjaxGetFieldText(nomeCampo_cliente_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_validate_cliente_nombre(var_cliente_nombre, var_script_case_init, do_ajax_form_tb_clientes_validate_cliente_nombre_cb);
  } // do_ajax_form_tb_clientes_validate_cliente_nombre

  function do_ajax_form_tb_clientes_validate_cliente_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_validate_cliente_nombre_cb

  // ---------- Validate cliente_telefono
  function do_ajax_form_tb_clientes_validate_cliente_telefono()
  {
    var nomeCampo_cliente_telefono = "cliente_telefono";
    var var_cliente_telefono = scAjaxGetFieldText(nomeCampo_cliente_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_validate_cliente_telefono(var_cliente_telefono, var_script_case_init, do_ajax_form_tb_clientes_validate_cliente_telefono_cb);
  } // do_ajax_form_tb_clientes_validate_cliente_telefono

  function do_ajax_form_tb_clientes_validate_cliente_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente_telefono";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_validate_cliente_telefono_cb

  // ---------- Validate cliente_direccion
  function do_ajax_form_tb_clientes_validate_cliente_direccion()
  {
    var nomeCampo_cliente_direccion = "cliente_direccion";
    var var_cliente_direccion = scAjaxGetFieldText(nomeCampo_cliente_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_validate_cliente_direccion(var_cliente_direccion, var_script_case_init, do_ajax_form_tb_clientes_validate_cliente_direccion_cb);
  } // do_ajax_form_tb_clientes_validate_cliente_direccion

  function do_ajax_form_tb_clientes_validate_cliente_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_validate_cliente_direccion_cb

  // ---------- Validate cliente_email
  function do_ajax_form_tb_clientes_validate_cliente_email()
  {
    var nomeCampo_cliente_email = "cliente_email";
    var var_cliente_email = scAjaxGetFieldText(nomeCampo_cliente_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_validate_cliente_email(var_cliente_email, var_script_case_init, do_ajax_form_tb_clientes_validate_cliente_email_cb);
  } // do_ajax_form_tb_clientes_validate_cliente_email

  function do_ajax_form_tb_clientes_validate_cliente_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_validate_cliente_email_cb

  // ---------- Validate users_login
  function do_ajax_form_tb_clientes_validate_users_login()
  {
    var nomeCampo_users_login = "users_login";
    var var_users_login = scAjaxGetFieldText(nomeCampo_users_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_validate_users_login(var_users_login, var_script_case_init, do_ajax_form_tb_clientes_validate_users_login_cb);
  } // do_ajax_form_tb_clientes_validate_users_login

  function do_ajax_form_tb_clientes_validate_users_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "users_login";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_validate_users_login_cb

  // ---------- Validate contrasena
  function do_ajax_form_tb_clientes_validate_contrasena()
  {
    var nomeCampo_contrasena = "contrasena";
    var var_contrasena = scAjaxGetFieldText(nomeCampo_contrasena);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_validate_contrasena(var_contrasena, var_script_case_init, do_ajax_form_tb_clientes_validate_contrasena_cb);
  } // do_ajax_form_tb_clientes_validate_contrasena

  function do_ajax_form_tb_clientes_validate_contrasena_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_validate_contrasena_cb

  // ---------- Validate confirma_contrasena
  function do_ajax_form_tb_clientes_validate_confirma_contrasena()
  {
    var nomeCampo_confirma_contrasena = "confirma_contrasena";
    var var_confirma_contrasena = scAjaxGetFieldText(nomeCampo_confirma_contrasena);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_validate_confirma_contrasena(var_confirma_contrasena, var_script_case_init, do_ajax_form_tb_clientes_validate_confirma_contrasena_cb);
  } // do_ajax_form_tb_clientes_validate_confirma_contrasena

  function do_ajax_form_tb_clientes_validate_confirma_contrasena_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "confirma_contrasena";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_validate_confirma_contrasena_cb

  // ---------- Refresh pais_id
  function do_ajax_form_tb_clientes_refresh_pais_id()
  {
    var var_pais_id = scAjaxGetFieldText("pais_id");
    var var_nmgp_refresh_fields = "docxpais_id";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tb_clientes_refresh_pais_id(var_pais_id, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tb_clientes_refresh_pais_id_cb);
  } // do_ajax_form_tb_clientes_refresh_pais_id

  function do_ajax_form_tb_clientes_refresh_pais_id_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_refresh_pais_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_clientes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_clientes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pais_id = scAjaxGetFieldText("pais_id");
    var var_docxpais_id = scAjaxGetFieldSelect("docxpais_id");
    var var_cliente_num_doc = scAjaxGetFieldText("cliente_num_doc");
    var var_cliente_nombre = scAjaxGetFieldText("cliente_nombre");
    var var_cliente_telefono = scAjaxGetFieldText("cliente_telefono");
    var var_cliente_direccion = scAjaxGetFieldText("cliente_direccion");
    var var_cliente_email = scAjaxGetFieldText("cliente_email");
    var var_users_login = scAjaxGetFieldText("users_login");
    var var_contrasena = scAjaxGetFieldText("contrasena");
    var var_confirma_contrasena = scAjaxGetFieldText("confirma_contrasena");
    ...
    scAjaxProcOn();
    x_ajax_form_tb_clientes_submit_form(var_pais_id, var_docxpais_id, var_cliente_num_doc, var_cliente_nombre, var_cliente_telefono, var_cliente_direccion, var_cliente_email, var_users_login, var_contrasena, var_confirma_contrasena, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_clientes_submit_form_cb);
  } // do_ajax_form_tb_clientes_submit_form

  function do_ajax_form_tb_clientes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pais_id");
      scAjaxHideErrorDisplay("docxpais_id");
      scAjaxHideErrorDisplay("cliente_num_doc");
      scAjaxHideErrorDisplay("cliente_nombre");
      scAjaxHideErrorDisplay("cliente_telefono");
      scAjaxHideErrorDisplay("cliente_direccion");
      scAjaxHideErrorDisplay("cliente_email");
      scAjaxHideErrorDisplay("users_login");
      scAjaxHideErrorDisplay("contrasena");
      scAjaxHideErrorDisplay("confirma_contrasena");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_clientes_submit_form_cb_after_alert);
  } // do_ajax_form_tb_clientes_submit_form_cb
  function do_ajax_form_tb_clientes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_clientes_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_clientes_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_clientes_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_clientes_navigate_form();
    }
  }

  function perform_ajax_form_tb_clientes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tb_clientes_navigate_form(var_id_cliente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_clientes_navigate_form_cb);
  } // do_ajax_form_tb_clientes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_clientes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_clientes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_clientes_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_clientes_navigate_form_cb
  function do_ajax_form_tb_clientes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tb_clientes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_clientes_navigate_form_cb_after_alert

  function sc_hide_form_tb_clientes_form()
  {
  ...
  ajax_field_list[0] = "pais_id";
  ajax_field_list[1] = "docxpais_id";
  ajax_field_list[2] = "cliente_num_doc";
  ajax_field_list[3] = "cliente_nombre";
  ajax_field_list[4] = "cliente_telefono";
  ajax_field_list[5] = "cliente_direccion";
  ajax_field_list[6] = "cliente_email";
  ajax_field_list[7] = "users_login";
  ajax_field_list[8] = "contrasena";
  ajax_field_list[9] = "confirma_contrasena";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "pais_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_clientes_fld_Pais_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "docxpais_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_clientes_fld_Docxpais_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cliente_num_doc": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_clientes_fld_Cliente_num_doc'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cliente_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_clientes_fld_Cliente_nombre'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cliente_telefono": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_clientes_fld_Cliente_telefono'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cliente_direccion": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_clientes_fld_Cliente_direccion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cliente_email": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_clientes_fld_Cliente_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "users_login": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_clientes_fld_users_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "contrasena": {"label": "Contraseña", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "confirma_contrasena": {"label": "Confirma Contraseña", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "pais_id": new Array(),
    "docxpais_id": new Array(),
    "cliente_num_doc": new Array(),
    "cliente_nombre": new Array(),
    "cliente_telefono": new Array(),
    "cliente_direccion": new Array(),
    "cliente_email": new Array(),
    "users_login": new Array(),
    "contrasena": new Array(),
    "confirma_contrasena": new Array()
  };
  ajax_field_mult["pais_id"][1] = "pais_id";
  ajax_field_mult["docxpais_id"][1] = "docxpais_id";
  ajax_field_mult["cliente_num_doc"][1] = "cliente_num_doc";
  ajax_field_mult["cliente_nombre"][1] = "cliente_nombre";
  ajax_field_mult["cliente_telefono"][1] = "cliente_telefono";
  ajax_field_mult["cliente_direccion"][1] = "cliente_direccion";
  ajax_field_mult["cliente_email"][1] = "cliente_email";
  ajax_field_mult["users_login"][1] = "users_login";
  ajax_field_mult["contrasena"][1] = "contrasena";
  ajax_field_mult["confirma_contrasena"][1] = "confirma_contrasena";

  var ajax_field_id = {
    "pais_id": new Array("hidden_field_label_pais_id", "hidden_field_data_pais_id"),
    "docxpais_id": new Array("hidden_field_label_docxpais_id", "hidden_field_data_docxpais_id"),
    "cliente_num_doc": new Array("hidden_field_label_cliente_num_doc", "hidden_field_data_cliente_num_doc"),
    "cliente_nombre": new Array("hidden_field_label_cliente_nombre", "hidden_field_data_cliente_nombre"),
    "cliente_telefono": new Array("hidden_field_label_cliente_telefono", "hidden_field_data_cliente_telefono"),
    ...
    "users_login": new Array("hidden_field_label_users_login", "hidden_field_data_users_login"),
    "contrasena": new Array("hidden_field_label_contrasena", "hidden_field_data_contrasena"),
    "confirma_contrasena": new Array("hidden_field_label_confirma_contrasena", "hidden_field_data_confirma_contrasena")
  };
  ...
  var ajax_read_only = {
    ...
    "cliente_num_doc": "off",
    "cliente_nombre": "off",
    "cliente_telefono": "off",
    "cliente_direccion": "off",
    "cliente_email": "off",
    "users_login": "off",
    "contrasena": "off",
    "confirma_contrasena": "off"
  };
