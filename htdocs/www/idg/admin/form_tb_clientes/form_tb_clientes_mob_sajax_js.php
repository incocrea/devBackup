  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_clientes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_clientes_mob_form();
	}
...
?>
  ...
  // ---------- Validate pais_id
  function do_ajax_form_tb_clientes_mob_validate_pais_id()
  {
  } // do_ajax_form_tb_clientes_mob_validate_pais_id

  function do_ajax_form_tb_clientes_mob_validate_pais_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_mob_validate_pais_id_cb

  // ---------- Validate docxpais_id
  function do_ajax_form_tb_clientes_mob_validate_docxpais_id()
  {
    var nomeCampo_docxpais_id = "docxpais_id";
    var var_docxpais_id = scAjaxGetFieldSelect(nomeCampo_docxpais_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_mob_validate_docxpais_id(var_docxpais_id, var_script_case_init, do_ajax_form_tb_clientes_mob_validate_docxpais_id_cb);
  } // do_ajax_form_tb_clientes_mob_validate_docxpais_id

  function do_ajax_form_tb_clientes_mob_validate_docxpais_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_mob_validate_docxpais_id_cb

  // ---------- Validate cliente_num_doc
  function do_ajax_form_tb_clientes_mob_validate_cliente_num_doc()
  {
    var nomeCampo_cliente_num_doc = "cliente_num_doc";
    var var_cliente_num_doc = scAjaxGetFieldText(nomeCampo_cliente_num_doc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_mob_validate_cliente_num_doc(var_cliente_num_doc, var_script_case_init, do_ajax_form_tb_clientes_mob_validate_cliente_num_doc_cb);
  } // do_ajax_form_tb_clientes_mob_validate_cliente_num_doc

  function do_ajax_form_tb_clientes_mob_validate_cliente_num_doc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_mob_validate_cliente_num_doc_cb

  // ---------- Validate cliente_nombre
  function do_ajax_form_tb_clientes_mob_validate_cliente_nombre()
  {
    var nomeCampo_cliente_nombre = "cliente_nombre";
    var var_cliente_nombre = scAjaxGetFieldText(nomeCampo_cliente_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_mob_validate_cliente_nombre(var_cliente_nombre, var_script_case_init, do_ajax_form_tb_clientes_mob_validate_cliente_nombre_cb);
  } // do_ajax_form_tb_clientes_mob_validate_cliente_nombre

  function do_ajax_form_tb_clientes_mob_validate_cliente_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_mob_validate_cliente_nombre_cb

  // ---------- Validate cliente_telefono
  function do_ajax_form_tb_clientes_mob_validate_cliente_telefono()
  {
    var nomeCampo_cliente_telefono = "cliente_telefono";
    var var_cliente_telefono = scAjaxGetFieldText(nomeCampo_cliente_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_mob_validate_cliente_telefono(var_cliente_telefono, var_script_case_init, do_ajax_form_tb_clientes_mob_validate_cliente_telefono_cb);
  } // do_ajax_form_tb_clientes_mob_validate_cliente_telefono

  function do_ajax_form_tb_clientes_mob_validate_cliente_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_mob_validate_cliente_telefono_cb

  // ---------- Validate cliente_direccion
  function do_ajax_form_tb_clientes_mob_validate_cliente_direccion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_mob_validate_cliente_direccion(var_cliente_direccion, var_script_case_init, do_ajax_form_tb_clientes_mob_validate_cliente_direccion_cb);
  } // do_ajax_form_tb_clientes_mob_validate_cliente_direccion

  function do_ajax_form_tb_clientes_mob_validate_cliente_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_mob_validate_cliente_direccion_cb

  // ---------- Validate cliente_email
  function do_ajax_form_tb_clientes_mob_validate_cliente_email()
  {
    var nomeCampo_cliente_email = "cliente_email";
    var var_cliente_email = scAjaxGetFieldText(nomeCampo_cliente_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_mob_validate_cliente_email(var_cliente_email, var_script_case_init, do_ajax_form_tb_clientes_mob_validate_cliente_email_cb);
  } // do_ajax_form_tb_clientes_mob_validate_cliente_email

  function do_ajax_form_tb_clientes_mob_validate_cliente_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_mob_validate_cliente_email_cb

  // ---------- Validate users_login
  function do_ajax_form_tb_clientes_mob_validate_users_login()
  {
    var nomeCampo_users_login = "users_login";
    var var_users_login = scAjaxGetFieldText(nomeCampo_users_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_mob_validate_users_login(var_users_login, var_script_case_init, do_ajax_form_tb_clientes_mob_validate_users_login_cb);
  } // do_ajax_form_tb_clientes_mob_validate_users_login

  function do_ajax_form_tb_clientes_mob_validate_users_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_mob_validate_users_login_cb

  // ---------- Validate contrasena
  function do_ajax_form_tb_clientes_mob_validate_contrasena()
  {
    var nomeCampo_contrasena = "contrasena";
    var var_contrasena = scAjaxGetFieldText(nomeCampo_contrasena);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_mob_validate_contrasena(var_contrasena, var_script_case_init, do_ajax_form_tb_clientes_mob_validate_contrasena_cb);
  } // do_ajax_form_tb_clientes_mob_validate_contrasena

  function do_ajax_form_tb_clientes_mob_validate_contrasena_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_mob_validate_contrasena_cb

  // ---------- Validate confirma_contrasena
  function do_ajax_form_tb_clientes_mob_validate_confirma_contrasena()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_clientes_mob_validate_confirma_contrasena(var_confirma_contrasena, var_script_case_init, do_ajax_form_tb_clientes_mob_validate_confirma_contrasena_cb);
  } // do_ajax_form_tb_clientes_mob_validate_confirma_contrasena

  function do_ajax_form_tb_clientes_mob_validate_confirma_contrasena_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_mob_validate_confirma_contrasena_cb

  // ---------- Refresh pais_id
  function do_ajax_form_tb_clientes_mob_refresh_pais_id()
  {
    var var_pais_id = scAjaxGetFieldText("pais_id");
    var var_nmgp_refresh_fields = "docxpais_id";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tb_clientes_mob_refresh_pais_id(var_pais_id, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tb_clientes_mob_refresh_pais_id_cb);
  } // do_ajax_form_tb_clientes_mob_refresh_pais_id

  function do_ajax_form_tb_clientes_mob_refresh_pais_id_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_clientes_mob_refresh_pais_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_clientes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_clientes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pais_id = scAjaxGetFieldText("pais_id");
    ...
    scAjaxProcOn();
    x_ajax_form_tb_clientes_mob_submit_form(var_pais_id, var_docxpais_id, var_cliente_num_doc, var_cliente_nombre, var_cliente_telefono, var_cliente_direccion, var_cliente_email, var_users_login, var_contrasena, var_confirma_contrasena, var_id_cliente, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_clientes_mob_submit_form_cb);
  } // do_ajax_form_tb_clientes_mob_submit_form

  function do_ajax_form_tb_clientes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_clientes_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tb_clientes_mob_submit_form_cb
  function do_ajax_form_tb_clientes_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_clientes_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_clientes_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_clientes_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_clientes_mob_navigate_form();
    }
  }

  function perform_ajax_form_tb_clientes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tb_clientes_mob_navigate_form(var_id_cliente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_clientes_mob_navigate_form_cb);
  } // do_ajax_form_tb_clientes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_clientes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_clientes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_clientes_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_clientes_mob_navigate_form_cb
  function do_ajax_form_tb_clientes_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tb_clientes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_clientes_mob_navigate_form_cb_after_alert

  function sc_hide_form_tb_clientes_mob_form()
  {
