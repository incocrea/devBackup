...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
/*NM*/            $_SESSION['scriptcase']['blank']['glo_nm_perfil'] = $NM_con_dest;
      ...
      {
          if (!isset($_SESSION['var_clixcur'])) 
          {
              $this->nm_falta_var .= "var_clixcur; ";
          }
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank']['glo_nm_conexao'], $this->root . $this->path_prod, 'vrcrenewable', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
if (!isset($_SESSION['var_clixcur'])) {$_SESSION['var_clixcur'] = "";}
if (!isset($this->sc_temp_var_clixcur)) {$this->sc_temp_var_clixcur = (isset($_SESSION['var_clixcur'])) ? $_SESSION['var_clixcur'] : "";}
 $check_sql = "SELECT
v.Tipodocumento,v.Cliente_num_doc,v.Cliente_nombre,v.Titulo,v.Fecha,v.estadocurso,v.Nombre,
c.codigoverificacion
FROM vw_clientesxcursos v, tb_confirmaciones c
WHERE
v.Id_clixcur = $this->sc_temp_var_clixcur and
c.clixcur_id = v.Id_clixcur
"
;
...
{
 $this->nm_mens_alert[] = "No existe";$this->nm_params_alert[] = array();}




$mensaje = '<h1 style="text-align:center">'.'El alumno: '.'<b>'.$var3.'</b></h1><br>'.'<h2 style="text-align:center">'.'Identificado con: '.$var1.' '.$var2.'</h2>'.'<br>'.
'<h3>'.'Realizó de manera satisfactoria el programa: '.'<br>'.$var4.'.'
.'<br>'.$var6.' en la fecha: '.$var5.'<br>'.'Certificado expedido por '.$var7.'<br>'.'</h3>'.
'<h2  style="border:2px solid SlateBlue;">'.'Código de verificación: '.$var8.'</h2>';



echo($mensaje);
if (isset($this->sc_temp_var_clixcur)) {$_SESSION['var_clixcur'] = $this->sc_temp_var_clixcur;}
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['blank']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['blank']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
<script type="text/javascript" src="../_lib/lib/js/frameControl.js"></script>

<script type="text/javascript" src="blank_message.js"></script>
<script type="text/javascript">
$(function() {
<?php
if (count($this->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['blank']['ajax_nav'])
           { 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blank") {
           ...
           if (isset($_COOKIE['sc_actual_lang_vrcrenewable'])) {
               $_SESSION['scriptcase']['blank']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_vrcrenewable'];
           }
       }
   }
   ...
   if (isset($_POST["var_clixcur"])) 
   {
       $_SESSION["var_clixcur"] = $_POST["var_clixcur"];
       nm_limpa_str_blank($_SESSION["var_clixcur"]);
   }
   if (isset($_GET["var_clixcur"])) 
   {
       $_SESSION["var_clixcur"] = $_GET["var_clixcur"];
       nm_limpa_str_blank($_SESSION["var_clixcur"]);
   }
   if (!isset($_SESSION["var_clixcur"])) 
   {
       $_SESSION["var_clixcur"] = "";
   }
   if (!empty($glo_perfil))  
   { 
   ...
   { 
       ...
       if (isset($var_clixcur)) 
       {
           $_SESSION['var_clixcur'] = $var_clixcur;
           nm_limpa_str_blank($_SESSION["var_clixcur"]);
       }
   } 
