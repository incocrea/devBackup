...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["vrcrenewable_____app_search_sec_groups"]))
   {
      unset($_SESSION['session_sec_aplicacao']["vrcrenewable_____app_search_sec_groups"]);
   }
