...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["vrcrenewable_____grid_tb_clientesxcursos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["vrcrenewable_____grid_tb_clientesxcursos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tb_clientesxcursos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tb_clientesxcursos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tb_clientesxcursos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tb_clientesxcursos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tb_clientesxcursos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tb_clientesxcursos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tb_clientesxcursos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tb_clientesxcursos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tb_clientesxcursos']['embutida_filho'] as $ind => $sc_init)
          {
