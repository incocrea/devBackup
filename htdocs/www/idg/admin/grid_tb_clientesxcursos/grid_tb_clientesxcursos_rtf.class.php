...
class grid_tb_clientesxcursos_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_tb_clientesxcursos.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tb_clientesxcursos']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tb_clientesxcursos']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tb_clientesxcursos']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tb_clientesxcursos']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tb_clientesxcursos']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tb_clientesxcursos']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_tb_clientesxcursos']['contr_erro'] = 'off'; 
   ...
   function NM_export_id_clixcur()
   {
         ...
         $this->id_clixcur = str_replace('<', '&lt;', $this->id_clixcur);
         $this->id_clixcur = str_replace('>', '&gt;', $this->id_clixcur);
         $this->Texto_tag .= "<td>" . $this->id_clixcur . "</td>\r\n";
   }
   //----- curxinst_id
   function NM_export_curxinst_id()
   {
         ...
         $this->curxinst_id = str_replace('<', '&lt;', $this->curxinst_id);
         $this->curxinst_id = str_replace('>', '&gt;', $this->curxinst_id);
         $this->Texto_tag .= "<td>" . $this->curxinst_id . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tb_clientesxcursos']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tb_clientesxcursos']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_tbl_tb_clientesxcursos'] ?> :: RTF</TITLE>
