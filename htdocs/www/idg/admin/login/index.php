...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_dt_criacao   = "20220817"; 
      $this->nm_hr_criacao   = "140343"; 
...
// 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['login']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['login']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['login']['sub_cons_schema_filter'];
      } 
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['login']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['login']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['login']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['login']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['login']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['login']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['login']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['login']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['login']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['login']['glo_nm_conexao'], $this->root . $this->path_prod, 'vrcrenewable', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['login']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['login']['embutida'])
      {
...
<?php
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['login']['iframe_print'] )
      {
          $target = "_parent";
      }
   ?>
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['login']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['login']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "login") {
           ...
           if (isset($_COOKIE['sc_actual_lang_vrcrenewable'])) {
               $_SESSION['scriptcase']['login']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_vrcrenewable'];
           }
       }
   }
