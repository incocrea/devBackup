...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["vrcrenewable_____grid_tb_confirmaciones"]))
   {
      unset($_SESSION['session_sec_aplicacao']["vrcrenewable_____grid_tb_confirmaciones"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tb_confirmaciones_edit'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tb_confirmaciones']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tb_confirmaciones']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tb_confirmaciones']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tb_confirmaciones']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tb_confirmaciones']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tb_confirmaciones</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tb_confirmaciones']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tb_confirmaciones']['embutida_filho'] as $ind => $sc_init)
          {
