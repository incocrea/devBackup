...
<?php
   ...
   $Ord_Cmp = new grid_tb_cursosxinstituciones_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tb_cursosxinstituciones_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['institucion_id'] = "Institucion_id";
   $tab_labels["institucion_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['labels']["institucion_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['labels']["institucion_id"] : "Empresa";
   $tab_ger_campos['course_id'] = "on";
   $tab_def_campos['course_id'] = "course_id";
   $tab_labels["course_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['labels']["course_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['labels']["course_id"] : "Course";
   $tab_ger_campos['estado_id'] = "on";
   $tab_def_campos['estado_id'] = "Estado_id";
   $tab_labels["estado_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['labels']["estado_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['labels']["estado_id"] : "Estado";
   $tab_ger_campos['fecha_inicio'] = "on";
   $tab_def_campos['fecha_inicio'] = "Fecha_inicio";
   $tab_labels["fecha_inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['labels']["fecha_inicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['labels']["fecha_inicio"] : "Fecha Inicio";
   $tab_ger_campos['fecha_terminacion'] = "on";
   $tab_def_campos['fecha_terminacion'] = "Fecha_terminacion";
   $tab_labels["fecha_terminacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['labels']["fecha_terminacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['labels']["fecha_terminacion"] : "Fecha Terminacion";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tb_cursosxinstituciones_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tb_cursosxinstituciones']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
