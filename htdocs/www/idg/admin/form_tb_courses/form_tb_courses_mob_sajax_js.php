  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_courses_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_courses_mob_form();
	}
...
?>
  ...
  // ---------- Validate course_id
  function do_ajax_form_tb_courses_mob_validate_course_id()
  {
    var nomeCampo_course_id = "course_id";
    var var_course_id = scAjaxGetFieldHidden(nomeCampo_course_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_courses_mob_validate_course_id(var_course_id, var_script_case_init, do_ajax_form_tb_courses_mob_validate_course_id_cb);
  } // do_ajax_form_tb_courses_mob_validate_course_id

  function do_ajax_form_tb_courses_mob_validate_course_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_courses_mob_validate_course_id_cb

  // ---------- Validate course_title
  function do_ajax_form_tb_courses_mob_validate_course_title()
  {
    var nomeCampo_course_title = "course_title";
    var var_course_title = scAjaxGetFieldText(nomeCampo_course_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_courses_mob_validate_course_title(var_course_title, var_script_case_init, do_ajax_form_tb_courses_mob_validate_course_title_cb);
  } // do_ajax_form_tb_courses_mob_validate_course_title

  function do_ajax_form_tb_courses_mob_validate_course_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_courses_mob_validate_course_title_cb

  // ---------- Validate course_descriptcion
  function do_ajax_form_tb_courses_mob_validate_course_descriptcion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_courses_mob_validate_course_descriptcion(var_course_descriptcion, var_script_case_init, do_ajax_form_tb_courses_mob_validate_course_descriptcion_cb);
  } // do_ajax_form_tb_courses_mob_validate_course_descriptcion

  function do_ajax_form_tb_courses_mob_validate_course_descriptcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_courses_mob_validate_course_descriptcion_cb

  // ---------- Validate course_lenght
  function do_ajax_form_tb_courses_mob_validate_course_lenght()
  {
    var nomeCampo_course_lenght = "course_lenght";
    var var_course_lenght = scAjaxGetFieldText(nomeCampo_course_lenght);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_courses_mob_validate_course_lenght(var_course_lenght, var_script_case_init, do_ajax_form_tb_courses_mob_validate_course_lenght_cb);
  } // do_ajax_form_tb_courses_mob_validate_course_lenght

  function do_ajax_form_tb_courses_mob_validate_course_lenght_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_courses_mob_validate_course_lenght_cb

  // ---------- Validate course_lang
  function do_ajax_form_tb_courses_mob_validate_course_lang()
  {
    var nomeCampo_course_lang = "course_lang";
    var var_course_lang = scAjaxGetFieldRadio(nomeCampo_course_lang);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_courses_mob_validate_course_lang(var_course_lang, var_script_case_init, do_ajax_form_tb_courses_mob_validate_course_lang_cb);
  } // do_ajax_form_tb_courses_mob_validate_course_lang

  function do_ajax_form_tb_courses_mob_validate_course_lang_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_courses_mob_validate_course_lang_cb

  // ---------- Validate course_img
  function do_ajax_form_tb_courses_mob_validate_course_img()
  {
    var nomeCampo_course_img = "course_img";
    var var_course_img = scAjaxGetFieldText(nomeCampo_course_img);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_courses_mob_validate_course_img(var_course_img, var_script_case_init, do_ajax_form_tb_courses_mob_validate_course_img_cb);
  } // do_ajax_form_tb_courses_mob_validate_course_img

  function do_ajax_form_tb_courses_mob_validate_course_img_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_courses_mob_validate_course_img_cb

  // ---------- Validate is_displayed
  function do_ajax_form_tb_courses_mob_validate_is_displayed()
  {
    var nomeCampo_is_displayed = "is_displayed";
    var var_is_displayed = scAjaxGetFieldRadio(nomeCampo_is_displayed);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_courses_mob_validate_is_displayed(var_is_displayed, var_script_case_init, do_ajax_form_tb_courses_mob_validate_is_displayed_cb);
  } // do_ajax_form_tb_courses_mob_validate_is_displayed

  function do_ajax_form_tb_courses_mob_validate_is_displayed_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_courses_mob_validate_is_displayed_cb

  // ---------- Validate inputs_course
  function do_ajax_form_tb_courses_mob_validate_inputs_course()
  {
    var nomeCampo_inputs_course = "inputs_course";
    var var_inputs_course = scAjaxGetFieldText(nomeCampo_inputs_course);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_courses_mob_validate_inputs_course(var_inputs_course, var_script_case_init, do_ajax_form_tb_courses_mob_validate_inputs_course_cb);
  } // do_ajax_form_tb_courses_mob_validate_inputs_course

  function do_ajax_form_tb_courses_mob_validate_inputs_course_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_courses_mob_validate_inputs_course_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_courses_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_courses_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tb_courses_mob_submit_form(var_course_id, var_course_title, var_course_descriptcion, var_course_lenght, var_course_lang, var_course_img, var_is_displayed, var_course_img_ul_name, var_course_img_ul_type, var_course_img_salva, var_course_img_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_courses_mob_submit_form_cb);
  } // do_ajax_form_tb_courses_mob_submit_form

  function do_ajax_form_tb_courses_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_courses_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tb_courses_mob_submit_form_cb
  function do_ajax_form_tb_courses_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_courses_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tb_insumos_x_cursos_mob"] = "off";

  function do_ajax_form_tb_courses_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_courses_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_courses_mob_navigate_form();
    }
  }

  function perform_ajax_form_tb_courses_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tb_insumos_x_cursos_mob"] = "on";
    x_ajax_form_tb_courses_mob_navigate_form(var_course_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_courses_mob_navigate_form_cb);
  } // do_ajax_form_tb_courses_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_courses_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_courses_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tb_insumos_x_cursos_mob"] && "nmsc_iframe_liga_form_tb_insumos_x_cursos_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tb_insumos_x_cursos_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tb_insumos_x_cursos_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tb_insumos_x_cursos_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tb_insumos_x_cursos_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tb_insumos_x_cursos_mob').style.display = "none";
    }
    document.F1.course_img_ul_name.value = '';
    document.F1.course_img_ul_type.value = '';
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_courses_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_courses_mob_navigate_form_cb
  function do_ajax_form_tb_courses_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tb_courses_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_courses_mob_navigate_form_cb_after_alert

  function sc_hide_form_tb_courses_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tb_insumos_x_cursos_mob"])
    {
      return true;
    }
    return false;
