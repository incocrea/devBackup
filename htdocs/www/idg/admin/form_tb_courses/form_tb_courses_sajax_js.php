  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_courses" == sTestField)
        {
...
?>
  ...
  // ---------- Validate course_id
  function do_ajax_form_tb_courses_validate_course_id()
  {
    var nomeCampo_course_id = "course_id";
    var var_course_id = scAjaxGetFieldHidden(nomeCampo_course_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_courses_validate_course_id(var_course_id, var_script_case_init, do_ajax_form_tb_courses_validate_course_id_cb);
  } // do_ajax_form_tb_courses_validate_course_id

  function do_ajax_form_tb_courses_validate_course_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "course_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_courses_validate_course_id_cb

  // ---------- Validate course_title
  function do_ajax_form_tb_courses_validate_course_title()
  {
    var nomeCampo_course_title = "course_title";
    var var_course_title = scAjaxGetFieldText(nomeCampo_course_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_courses_validate_course_title(var_course_title, var_script_case_init, do_ajax_form_tb_courses_validate_course_title_cb);
  } // do_ajax_form_tb_courses_validate_course_title

  function do_ajax_form_tb_courses_validate_course_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "course_title";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_courses_validate_course_title_cb

  // ---------- Validate course_descriptcion
  function do_ajax_form_tb_courses_validate_course_descriptcion()
  {
    var nomeCampo_course_descriptcion = "course_descriptcion";
    var var_course_descriptcion = scAjaxGetFieldText(nomeCampo_course_descriptcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_courses_validate_course_descriptcion(var_course_descriptcion, var_script_case_init, do_ajax_form_tb_courses_validate_course_descriptcion_cb);
  } // do_ajax_form_tb_courses_validate_course_descriptcion

  function do_ajax_form_tb_courses_validate_course_descriptcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "course_descriptcion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_courses_validate_course_descriptcion_cb

  // ---------- Validate course_lenght
  function do_ajax_form_tb_courses_validate_course_lenght()
  {
    var nomeCampo_course_lenght = "course_lenght";
    var var_course_lenght = scAjaxGetFieldText(nomeCampo_course_lenght);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_courses_validate_course_lenght(var_course_lenght, var_script_case_init, do_ajax_form_tb_courses_validate_course_lenght_cb);
  } // do_ajax_form_tb_courses_validate_course_lenght

  function do_ajax_form_tb_courses_validate_course_lenght_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "course_lenght";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_courses_validate_course_lenght_cb

  // ---------- Validate course_lang
  function do_ajax_form_tb_courses_validate_course_lang()
  {
    var nomeCampo_course_lang = "course_lang";
    var var_course_lang = scAjaxGetFieldRadio(nomeCampo_course_lang);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_courses_validate_course_lang(var_course_lang, var_script_case_init, do_ajax_form_tb_courses_validate_course_lang_cb);
  } // do_ajax_form_tb_courses_validate_course_lang

  function do_ajax_form_tb_courses_validate_course_lang_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "course_lang";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_courses_validate_course_lang_cb

  // ---------- Validate course_img
  function do_ajax_form_tb_courses_validate_course_img()
  {
    var nomeCampo_course_img = "course_img";
    var var_course_img = scAjaxGetFieldText(nomeCampo_course_img);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_courses_validate_course_img(var_course_img, var_script_case_init, do_ajax_form_tb_courses_validate_course_img_cb);
  } // do_ajax_form_tb_courses_validate_course_img

  function do_ajax_form_tb_courses_validate_course_img_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "course_img";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_courses_validate_course_img_cb

  // ---------- Validate is_displayed
  function do_ajax_form_tb_courses_validate_is_displayed()
  {
    var nomeCampo_is_displayed = "is_displayed";
    var var_is_displayed = scAjaxGetFieldRadio(nomeCampo_is_displayed);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_courses_validate_is_displayed(var_is_displayed, var_script_case_init, do_ajax_form_tb_courses_validate_is_displayed_cb);
  } // do_ajax_form_tb_courses_validate_is_displayed

  function do_ajax_form_tb_courses_validate_is_displayed_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "is_displayed";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_courses_validate_is_displayed_cb

  // ---------- Validate inputs_course
  function do_ajax_form_tb_courses_validate_inputs_course()
  {
    var nomeCampo_inputs_course = "inputs_course";
    var var_inputs_course = scAjaxGetFieldText(nomeCampo_inputs_course);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_courses_validate_inputs_course(var_inputs_course, var_script_case_init, do_ajax_form_tb_courses_validate_inputs_course_cb);
  } // do_ajax_form_tb_courses_validate_inputs_course

  function do_ajax_form_tb_courses_validate_inputs_course_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "inputs_course";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_courses_validate_inputs_course_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_courses_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_courses_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_course_id = scAjaxGetFieldHidden("course_id");
    var var_course_title = scAjaxGetFieldText("course_title");
    var var_course_descriptcion = scAjaxGetFieldText("course_descriptcion");
    var var_course_lenght = scAjaxGetFieldText("course_lenght");
    var var_course_lang = scAjaxGetFieldRadio("course_lang");
    var var_course_img = scAjaxGetFieldText("course_img");
    var var_is_displayed = scAjaxGetFieldRadio("is_displayed");
    var var_course_img_ul_name = scAjaxSpecCharProtect(document.F1.course_img_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_course_img_ul_type = document.F1.course_img_ul_type.value;
    var var_course_img_salva = scAjaxSpecCharProtect(document.F1.course_img_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_course_img_limpa = document.F1.course_img_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_tb_courses_submit_form(var_course_id, var_course_title, var_course_descriptcion, var_course_lenght, var_course_lang, var_course_img, var_is_displayed, var_course_img_ul_name, var_course_img_ul_type, var_course_img_salva, var_course_img_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_courses_submit_form_cb);
  } // do_ajax_form_tb_courses_submit_form

  function do_ajax_form_tb_courses_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("course_id");
      scAjaxHideErrorDisplay("course_title");
      scAjaxHideErrorDisplay("course_descriptcion");
      scAjaxHideErrorDisplay("course_lenght");
      scAjaxHideErrorDisplay("course_lang");
      scAjaxHideErrorDisplay("course_img");
      scAjaxHideErrorDisplay("is_displayed");
      scAjaxHideErrorDisplay("inputs_course");
      scLigEditLookupCall();
<?php
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.course_img_limpa && document.F1.course_img_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("course_img", oImgTemp, "", "", "", "N");
      }
    document.F1.course_img_ul_name.value = '';
    document.F1.course_img_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scBtnDisabled();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_courses_submit_form_cb_after_alert);
  } // do_ajax_form_tb_courses_submit_form_cb
  function do_ajax_form_tb_courses_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_courses_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tb_insumos_x_cursos"] = "off";

  function do_ajax_form_tb_courses_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_courses_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_courses_navigate_form();
    }
  }

  function perform_ajax_form_tb_courses_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("is_displayed");
    scAjaxHideErrorDisplay("inputs_course");
    var var_course_id = document.F2.course_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tb_insumos_x_cursos"] = "on";
    x_ajax_form_tb_courses_navigate_form(var_course_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_courses_navigate_form_cb);
  } // do_ajax_form_tb_courses_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_courses']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_courses_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.course_id.value = scAjaxGetKeyValue("course_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tb_insumos_x_cursos"] && "nmsc_iframe_liga_form_tb_insumos_x_cursos" != scMasterDetailIframe["nmsc_iframe_liga_form_tb_insumos_x_cursos"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tb_insumos_x_cursos"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tb_insumos_x_cursos').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tb_insumos_x_cursos').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tb_insumos_x_cursos').style.display = "none";
    }
    document.F1.course_img_ul_name.value = '';
    document.F1.course_img_ul_type.value = '';
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_courses_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_courses_navigate_form_cb
  function do_ajax_form_tb_courses_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tb_courses_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_courses_navigate_form_cb_after_alert

  function sc_hide_form_tb_courses_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tb_insumos_x_cursos"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "course_id";
  ajax_field_list[1] = "course_title";
  ajax_field_list[2] = "course_descriptcion";
  ajax_field_list[3] = "course_lenght";
  ajax_field_list[4] = "course_lang";
  ajax_field_list[5] = "course_img";
  ajax_field_list[6] = "is_displayed";
  ajax_field_list[7] = "inputs_course";
  ...
  var ajax_error_list = {
    "course_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_courses_fld_course_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "course_title": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_courses_fld_course_title'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "course_descriptcion": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_courses_fld_course_descriptcion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "course_lenght": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_courses_fld_course_lenght'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "course_lang": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_courses_fld_course_lang'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "course_img": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_courses_fld_course_img'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "is_displayed": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_courses_fld_is_displayed'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inputs_course": {"label": "inputs by course", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "course_descriptcion": new Array(),
    "course_lenght": new Array(),
    "course_lang": new Array(),
    "course_img": new Array(),
    "is_displayed": new Array(),
    "inputs_course": new Array()
  };
  ajax_field_mult["course_id"][1] = "course_id";
  ajax_field_mult["course_title"][1] = "course_title";
  ajax_field_mult["course_descriptcion"][1] = "course_descriptcion";
  ajax_field_mult["course_lenght"][1] = "course_lenght";
  ajax_field_mult["course_lang"][1] = "course_lang";
  ajax_field_mult["course_img"][1] = "course_img";
  ajax_field_mult["is_displayed"][1] = "is_displayed";
  ajax_field_mult["inputs_course"][1] = "inputs_course";

  var ajax_field_id = {
    "course_title": new Array("hidden_field_label_course_title", "hidden_field_data_course_title"),
    "course_descriptcion": new Array("hidden_field_label_course_descriptcion", "hidden_field_data_course_descriptcion"),
    "course_lenght": new Array("hidden_field_label_course_lenght", "hidden_field_data_course_lenght"),
    "course_lang": new Array("hidden_field_label_course_lang", "hidden_field_data_course_lang"),
    "course_img": new Array("hidden_field_label_course_img", "hidden_field_data_course_img"),
    "is_displayed": new Array("hidden_field_label_is_displayed", "hidden_field_data_is_displayed"),
    "inputs_course": new Array("hidden_field_label_inputs_course", "hidden_field_data_inputs_course")
  };

  var ajax_read_only = {
    "course_id": "on",
    "course_title": "off",
    "course_descriptcion": "off",
    "course_lenght": "off",
    "course_lang": "off",
    "course_img": "off",
    "is_displayed": "off",
