...
<?php
   ...
   $Ord_Cmp = new grid_tb_instituciones_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tb_instituciones_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['labels']["nombre"] : "" . $this->Nm_lang['lang_tb_instituciones_fld_Nombre'] . "";
   $tab_ger_campos['telefono'] = "on";
   $tab_def_campos['telefono'] = "Telefono";
   $tab_labels["telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['labels']["telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['labels']["telefono"] : "" . $this->Nm_lang['lang_tb_instituciones_fld_Telefono'] . "";
   $tab_ger_campos['direccion'] = "on";
   $tab_def_campos['direccion'] = "Direccion";
   $tab_labels["direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['labels']["direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['labels']["direccion"] : "" . $this->Nm_lang['lang_tb_instituciones_fld_Direccion'] . "";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "Email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['labels']["email"] : "" . $this->Nm_lang['lang_tb_instituciones_fld_Email'] . "";
   $tab_ger_campos['activa'] = "on";
   $tab_def_campos['activa'] = "Activa";
   $tab_labels["activa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['labels']["activa"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['labels']["activa"] : "" . $this->Nm_lang['lang_tb_instituciones_fld_Activa'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tb_instituciones_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tb_instituciones']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
