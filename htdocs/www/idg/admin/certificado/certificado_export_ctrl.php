<?php
@session_start() ;
$_SESSION['scriptcase']['certificado']['sc_process_barr'] = true;
require_once('../certificado/index.php');
unset($_SESSION['scriptcase']['certificado']['sc_process_barr']);
$ExportCtrl = new certificado_export_control;
$ExportCtrl->Export_barr();

class certificado_export_control
{
