<?php
   ...
   $_SESSION['scriptcase']['blank_2']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['blank_2']['glo_nm_path_doc']        = "";
    ...
    //check cache
    if(empty($_SESSION['scriptcase']['blank_2']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_2']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_hr_criacao   = "190558"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20230117"; 
      $this->nm_hr_ult_alt   = "173916"; 
...
// 
      ...
      $this->path_cache  = $_SESSION['scriptcase']['blank_2']['glo_nm_path_cache'];
      ...
      if (!isset($_SESSION['scriptcase']['blank_2']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['blank_2']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['blank_2']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['blank_2']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['blank_2']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['blank_2']['sub_cons_schema_filter'];
      } 
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_2']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['blank_2']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['blank_2']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['blank_2']['actual_lang']) || $_SESSION['scriptcase']['blank_2']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['blank_2']['actual_lang'] = $this->str_lang;
    ...
    $out1_img_cache = $_SESSION['scriptcase']['blank_2']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['blank_2']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_2"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_2"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_2']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_2']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_2']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_2']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_2']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_2']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_2']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_2']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_2']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_2']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_2']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blank_2']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_2']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['blank_2']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_2']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_2']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['blank_2']['session_timeout']['redir']))
      {
...
// 
      ...
      if (isset($_SESSION['scriptcase']['blank_2']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['blank_2']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['blank_2']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['blank_2']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['blank_2']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['blank_2']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
/*NM*/            $_SESSION['scriptcase']['blank_2']['glo_nm_perfil'] = $NM_con_dest;
      ...
      {
          if (!isset($_SESSION['id_insumos'])) 
          {
              $this->nm_falta_var .= "id_insumos; ";
          }
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank_2']['glo_nm_conexao'], $this->root . $this->path_prod, 'vrcrenewable', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_2']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['blank_2']['embutida'])
      {
...
// 
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_2']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_2']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_2']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_2']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
if (!isset($_SESSION['id_insumos'])) {$_SESSION['id_insumos'] = "";}
if (!isset($this->sc_temp_id_insumos)) {$this->sc_temp_id_insumos = (isset($_SESSION['id_insumos'])) ? $_SESSION['id_insumos'] : "";}
 $check_sql = "SELECT enbed"
   . " FROM tb_insumos_x_cursos"
   . " WHERE id_insumos = '" . $this->sc_temp_id_insumos . "'";
...
<?php
echo '<h3>'.$this->Ini->Nm_lang['lang_close_window'].'</h3><br>';
echo  $video ;	?>
...
$this->nm_mens_alert[] = "Insertado con éxito!";$this->nm_params_alert[] = $params;
if (isset($this->sc_temp_id_insumos)) {$_SESSION['id_insumos'] = $this->sc_temp_id_insumos;}
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['blank_2']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['blank_2']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
<script type="text/javascript" src="../_lib/lib/js/frameControl.js"></script>

<script type="text/javascript" src="blank_2_message.js"></script>
<script type="text/javascript">
$(function() {
<?php
if (count($this->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['blank_2']['ajax_nav'])
           { 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank_2']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank_2']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blank_2") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['blank_2']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['blank_2']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['blank_2']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_vrcrenewable'])) {
               $_SESSION['scriptcase']['blank_2']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_vrcrenewable'];
           }
       }
   }
   ...
   {
       $_SESSION["id_insumos"] = $_POST["id_insumos"];
       nm_limpa_str_blank_2($_SESSION["id_insumos"]);
   }
   if (isset($_GET["id_insumos"])) 
   {
       $_SESSION["id_insumos"] = $_GET["id_insumos"];
       nm_limpa_str_blank_2($_SESSION["id_insumos"]);
   }
   if (!isset($_SESSION["id_insumos"])) 
   {
   ...
   { 
       ...
       if (isset($id_insumos)) 
       {
           $_SESSION['id_insumos'] = $id_insumos;
           nm_limpa_str_blank_2($_SESSION["id_insumos"]);
       }
   } 
