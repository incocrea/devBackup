...
$aLookup[] = array(app_form_add_users_mob_pack_protect_string('Administrador') => str_replace('<', '&lt;',app_form_add_users_mob_pack_protect_string("Administrador")));
$aLookup[] = array(app_form_add_users_mob_pack_protect_string('Estudiante') => str_replace('<', '&lt;',app_form_add_users_mob_pack_protect_string("Estudiante")));
$aLookup[] = array(app_form_add_users_mob_pack_protect_string('Empresa') => str_replace('<', '&lt;',app_form_add_users_mob_pack_protect_string("Empresa")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['Lookup_mfa'][] = 'Administrador';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['Lookup_mfa'][] = 'Estudiante';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['Lookup_mfa'][] = 'Empresa';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"mfa\"";
          ...
          {
              $this->NM_ajax_info['fldList']['mfa']['valList'][$i] = app_form_add_users_mob_pack_protect_string($v);
          }
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
             ...
             { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('picture', 'login', 'pswd', 'confirm_pswd', 'name', 'email', 'mfa'), $aDoNotUpdate);
              $this->ajax_return_values();
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "Administrador?#?Administrador?#?N?@?";
       $nmgp_def_dados .= "Estudiante?#?Estudiante?#?N?@?";
