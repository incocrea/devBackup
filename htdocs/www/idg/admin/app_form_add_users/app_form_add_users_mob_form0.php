...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['Lookup_mfa'][] = 'Administrador'; ?>
 <option  value="Estudiante" <?php  if ($this->mfa == "Estudiante") { echo " selected" ;} ?>>Estudiante</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['Lookup_mfa'][] = 'Estudiante'; ?>
 <option  value="Empresa" <?php  if ($this->mfa == "Empresa") { echo " selected" ;} ?>>Empresa</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['Lookup_mfa'][] = 'Empresa'; ?>
 </select></span>
</span><?php  }?>
