<?php
@session_start() ;
$_SESSION['scriptcase']['certificado_seg']['sc_process_barr'] = true;
require_once('../certificado_seg/index.php');
unset($_SESSION['scriptcase']['certificado_seg']['sc_process_barr']);
$ExportCtrl = new certificado_seg_export_control;
$ExportCtrl->Export_barr();

class certificado_seg_export_control
{
