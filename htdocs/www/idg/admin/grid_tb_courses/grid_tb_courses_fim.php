...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["vrcrenewable_____grid_tb_courses"]))
   {
      unset($_SESSION['session_sec_aplicacao']["vrcrenewable_____grid_tb_courses"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tb_courses'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tb_courses']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tb_courses']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tb_courses']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tb_courses']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tb_courses']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tb_courses']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tb_courses']['embutida_filho'] as $ind => $sc_init)
          {
