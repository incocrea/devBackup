<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tb_courses']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tb_courses_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tb_courses_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tb_courses']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['course_id'] = "course_id";
   $tab_labels["course_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_courses']['labels']["course_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['labels']["course_id"] : "" . $this->Nm_lang['lang_tb_courses_fld_course_id'] . "";
   $tab_ger_campos['course_title'] = "on";
   $tab_def_campos['course_title'] = "course_title";
   $tab_labels["course_title"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_courses']['labels']["course_title"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['labels']["course_title"] : "" . $this->Nm_lang['lang_tb_courses_fld_course_title'] . "";
   $tab_ger_campos['course_descriptcion'] = "on";
   $tab_def_campos['course_descriptcion'] = "course_descriptcion";
   $tab_labels["course_descriptcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_courses']['labels']["course_descriptcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['labels']["course_descriptcion"] : "" . $this->Nm_lang['lang_tb_courses_fld_course_descriptcion'] . "";
   $tab_ger_campos['course_lenght'] = "on";
   $tab_def_campos['course_lenght'] = "course_lenght";
   $tab_labels["course_lenght"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_courses']['labels']["course_lenght"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['labels']["course_lenght"] : "" . $this->Nm_lang['lang_tb_courses_fld_course_lenght'] . "";
   $tab_ger_campos['course_lang'] = "on";
   $tab_def_campos['course_lang'] = "course_lang";
   $tab_labels["course_lang"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_courses']['labels']["course_lang"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['labels']["course_lang"] : "" . $this->Nm_lang['lang_tb_courses_fld_course_lang'] . "";
   $tab_ger_campos['course_img'] = "on";
   $tab_def_campos['course_img'] = "course_img";
   $tab_labels["course_img"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_courses']['labels']["course_img"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['labels']["course_img"] : "" . $this->Nm_lang['lang_tb_courses_fld_course_img'] . "";
   $tab_ger_campos['is_displayed'] = "on";
   $tab_def_campos['is_displayed'] = "is_displayed";
   $tab_labels["is_displayed"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_courses']['labels']["is_displayed"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['labels']["is_displayed"] : "" . $this->Nm_lang['lang_tb_courses_fld_is_displayed'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_courses']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tb_courses']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tb_courses']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tb_courses']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_courses']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tb_courses']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> tb_courses</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tb_courses_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_courses']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tb_courses']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
