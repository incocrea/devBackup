<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['cursos_alumnos']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new cursos_alumnos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class cursos_alumnos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['cursos_alumnos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["tb_clientes_cliente_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['cursos_alumnos']['labels']["tb_clientes_cliente_nombre"])) ? $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['labels']["tb_clientes_cliente_nombre"] : "" . $this->Nm_lang['lang_tb_clientes_fld_Cliente_nombre'] . "";
   $tab_ger_campos['tb_courses_course_title'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_courses_course_title'] = "tb_courses_course_title";
   }
   else
   {
       $tab_def_campos['tb_courses_course_title'] = "tb_courses.course_title";
   }
   $tab_labels["tb_courses_course_title"]   = (isset($_SESSION['sc_session'][$sc_init]['cursos_alumnos']['labels']["tb_courses_course_title"])) ? $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['labels']["tb_courses_course_title"] : "" . $this->Nm_lang['lang_tb_courses_fld_course_title'] . "";
   $tab_ger_campos['tb_courses_course_descriptcion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_courses_course_descriptcion'] = "tb_courses_course_descriptcion";
   }
   else
   {
       $tab_def_campos['tb_courses_course_descriptcion'] = "tb_courses.course_descriptcion";
   }
   $tab_labels["tb_courses_course_descriptcion"]   = (isset($_SESSION['sc_session'][$sc_init]['cursos_alumnos']['labels']["tb_courses_course_descriptcion"])) ? $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['labels']["tb_courses_course_descriptcion"] : "" . $this->Nm_lang['lang_tb_courses_fld_course_descriptcion'] . "";
   $tab_ger_campos['tb_courses_course_lenght'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_courses_course_lenght'] = "tb_courses_course_lenght";
   }
   else
   {
       $tab_def_campos['tb_courses_course_lenght'] = "tb_courses.course_lenght";
   }
   $tab_labels["tb_courses_course_lenght"]   = (isset($_SESSION['sc_session'][$sc_init]['cursos_alumnos']['labels']["tb_courses_course_lenght"])) ? $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['labels']["tb_courses_course_lenght"] : "" . $this->Nm_lang['lang_tb_courses_fld_course_lenght'] . "";
   $tab_ger_campos['tb_courses_course_lang'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_courses_course_lang'] = "tb_courses_course_lang";
   }
   else
   {
       $tab_def_campos['tb_courses_course_lang'] = "tb_courses.course_lang";
   }
   $tab_labels["tb_courses_course_lang"]   = (isset($_SESSION['sc_session'][$sc_init]['cursos_alumnos']['labels']["tb_courses_course_lang"])) ? $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['labels']["tb_courses_course_lang"] : "" . $this->Nm_lang['lang_tb_courses_fld_course_lang'] . "";
   $tab_ger_campos['tb_courses_is_displayed'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_courses_is_displayed'] = "tb_courses_is_displayed";
   }
   else
   {
       $tab_def_campos['tb_courses_is_displayed'] = "tb_courses.is_displayed";
   }
   $tab_labels["tb_courses_is_displayed"]   = (isset($_SESSION['sc_session'][$sc_init]['cursos_alumnos']['labels']["tb_courses_is_displayed"])) ? $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['labels']["tb_courses_is_displayed"] : "" . $this->Nm_lang['lang_tb_courses_fld_is_displayed'] . "";
   $tab_ger_campos['tb_courses_course_img'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tb_courses_course_img'] = "tb_courses_course_img";
   }
   else
   {
       $tab_def_campos['tb_courses_course_img'] = "tb_courses.course_img";
   }
   $tab_labels["tb_courses_course_img"]   = (isset($_SESSION['sc_session'][$sc_init]['cursos_alumnos']['labels']["tb_courses_course_img"])) ? $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['labels']["tb_courses_course_img"] : "" . $this->Nm_lang['lang_tb_courses_fld_course_img'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['cursos_alumnos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['cursos_alumnos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['cursos_alumnos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['cursos_alumnos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['cursos_alumnos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['cursos_alumnos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "cursos_alumnos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['cursos_alumnos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['cursos_alumnos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
