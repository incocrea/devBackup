...
class cursos_alumnos_res_rtf
{
   ...
   function gera_texto_tag()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['pivot_group_by'];
      ...
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['arr_export']['data'];
