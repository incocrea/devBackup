...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "cursos_alumnos.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['rtf_name']);
      }
   ...
   function NM_export_tb_courses_course_title()
   {
         ...
         $this->tb_courses_course_title = str_replace('<', '&lt;', $this->tb_courses_course_title);
         $this->tb_courses_course_title = str_replace('>', '&gt;', $this->tb_courses_course_title);
         $this->Texto_tag .= "<td>" . $this->tb_courses_course_title . "</td>\r\n";
   }
   ...
   function NM_export_tb_courses_course_descriptcion()
   {
         ...
         $this->tb_courses_course_descriptcion = str_replace('<', '&lt;', $this->tb_courses_course_descriptcion);
         $this->tb_courses_course_descriptcion = str_replace('>', '&gt;', $this->tb_courses_course_descriptcion);
         $this->Texto_tag .= "<td>" . $this->tb_courses_course_descriptcion . "</td>\r\n";
   }
   ...
   function NM_export_tb_courses_course_lenght()
   {
         ...
         $this->tb_courses_course_lenght = str_replace('<', '&lt;', $this->tb_courses_course_lenght);
         $this->tb_courses_course_lenght = str_replace('>', '&gt;', $this->tb_courses_course_lenght);
         $this->Texto_tag .= "<td>" . $this->tb_courses_course_lenght . "</td>\r\n";
   }
   ...
   function NM_export_tb_courses_course_lang()
   {
         ...
         $this->tb_courses_course_lang = str_replace('<', '&lt;', $this->tb_courses_course_lang);
         $this->tb_courses_course_lang = str_replace('>', '&gt;', $this->tb_courses_course_lang);
         $this->Texto_tag .= "<td>" . $this->tb_courses_course_lang . "</td>\r\n";
   }
   ...
   function NM_export_tb_courses_is_displayed()
   {
         ...
         $this->tb_courses_is_displayed = str_replace('<', '&lt;', $this->tb_courses_is_displayed);
         $this->tb_courses_is_displayed = str_replace('>', '&gt;', $this->tb_courses_is_displayed);
         $this->Texto_tag .= "<td>" . $this->tb_courses_is_displayed . "</td>\r\n";
   }
   ...
   function NM_export_tb_courses_course_img()
   {
         ...
         $this->tb_courses_course_img = str_replace('<', '&lt;', $this->tb_courses_course_img);
         $this->tb_courses_course_img = str_replace('>', '&gt;', $this->tb_courses_course_img);
         $this->Texto_tag .= "<td>" . $this->tb_courses_course_img . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
