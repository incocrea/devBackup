...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "cursos_alumnos/cursos_alumnos_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_format'];
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_return']);
      ...
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "cursos_alumnos.json";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_name']);
      }
      ...
      { 
          ...
          { 
              ...
              $this->Res = new cursos_alumnos_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_res_grid']);
          } 
      }
   ...
   function NM_export_tb_courses_course_title()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->tb_courses_course_title;
   }
   ...
   function NM_export_tb_courses_course_descriptcion()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->tb_courses_course_descriptcion;
   }
   ...
   function NM_export_tb_courses_course_lenght()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->tb_courses_course_lenght;
   }
   ...
   function NM_export_tb_courses_course_lang()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->tb_courses_course_lang;
   }
   ...
   function NM_export_tb_courses_is_displayed()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->tb_courses_is_displayed;
   }
   //----- tb_courses_course_img
   function NM_export_tb_courses_course_img()
   {
         $this->tb_courses_course_img = NM_charset_to_utf8($this->tb_courses_course_img);
         if ($this->Json_use_label)
         {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->tb_courses_course_img;
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['cursos_alumnos']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
