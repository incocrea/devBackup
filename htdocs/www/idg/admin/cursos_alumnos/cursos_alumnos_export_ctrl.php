<?php
@session_start() ;
$_SESSION['scriptcase']['cursos_alumnos']['sc_process_barr'] = true;
require_once('../cursos_alumnos/index.php');
unset($_SESSION['scriptcase']['cursos_alumnos']['sc_process_barr']);
$ExportCtrl = new cursos_alumnos_export_control;
$ExportCtrl->Export_barr();

class cursos_alumnos_export_control
{
