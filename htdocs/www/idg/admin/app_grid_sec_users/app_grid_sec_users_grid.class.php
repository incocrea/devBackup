...
//----- 
   ...
   { 
       $nmgp_select = "SELECT picture, login, name, email, active, mfa from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT picture, login, name, email, active, mfa from " . $this->Ini->nm_tabela; 
   ...
   { 
       ...
       $this->mfa = $this->rs_grid->fields[5] ;  
...
$nm_saida->saida("}\r\n");
 ...
 {  
   ...
   $this->css_mfa_label = $compl_css_emb . "css_mfa_label";
   $this->css_mfa_grid_line = $compl_css_emb . "css_mfa_grid_line";
 }  
 function cabecalho()
 {
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_mfa_label'] . "\" >&nbsp;</TD>\r\n");
   } 
 ...
 function NM_label_mfa()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['mfa'])) ? $this->New_label['mfa'] : "Perfil";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['mfa']) || $this->NM_cmp_hidden['mfa'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_mfa_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_mfa_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('mfa');
        $fieldSortIcon = $this->scGetColumnOrderIcon('mfa', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
        ...
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('mfa')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = '';
...
// 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_mfa_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 ...
 function NM_grid_mfa()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['mfa']) || $this->NM_cmp_hidden['mfa'] != "off") { 
          $conteudo = sc_strip_script($this->mfa); 
          $conteudo_original = sc_strip_script($this->mfa); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_mfa_grid_line . "\"  style=\"" . $this->Css_Cmp['css_mfa_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_mfa_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
