<?php
   ...
   $_SESSION['scriptcase']['blank_fondo']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['blank_fondo']['glo_nm_path_doc']        = "";
    ...
    //check cache
    if(empty($_SESSION['scriptcase']['blank_fondo']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_fondo']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_dt_criacao   = "20220809"; 
      $this->nm_hr_criacao   = "143418"; 
...
// 
      ...
      $this->path_cache  = $_SESSION['scriptcase']['blank_fondo']['glo_nm_path_cache'];
      ...
      if (!isset($_SESSION['scriptcase']['blank_fondo']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['blank_fondo']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['blank_fondo']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['blank_fondo']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['sub_cons_schema_filter'];
      } 
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
    ...
    $out1_img_cache = $_SESSION['scriptcase']['blank_fondo']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['blank_fondo']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_fondo']['dashboard_info']['under_dashboard']))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              ...
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              ...
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['blank_fondo']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_fondo']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_fondo']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_fondo']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_fondo']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blank_fondo']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['blank_fondo']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['blank_fondo']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_fondo']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank_fondo']['glo_nm_conexao'], $this->root . $this->path_prod, 'vrcrenewable', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_fondo']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['blank_fondo']['embutida'])
      {
...
<style> 
body {
  background-image: url("https://vrcrenewable.com/aurora.jpg"); 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank_fondo']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank_fondo']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blank_fondo") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['blank_fondo']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['blank_fondo']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['blank_fondo']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_vrcrenewable'])) {
               $_SESSION['scriptcase']['blank_fondo']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_vrcrenewable'];
           }
       }
   }
