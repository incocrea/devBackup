...
<?php
   ...
   $Ord_Cmp = new grid_tb_insumos_x_cursos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tb_insumos_x_cursos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_insumos'] = "id_insumos";
   $tab_labels["id_insumos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['labels']["id_insumos"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['labels']["id_insumos"] : "Id Insumos";
   $tab_ger_campos['course_id'] = "on";
   $tab_def_campos['course_id'] = "course_id";
   $tab_labels["course_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['labels']["course_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['labels']["course_id"] : "Course Id";
   $tab_ger_campos['topico'] = "on";
   $tab_def_campos['topico'] = "topico";
   $tab_labels["topico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['labels']["topico"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['labels']["topico"] : "" . $this->Nm_lang['lang_topicos'] . "";
   $tab_ger_campos['documentos'] = "on";
   $tab_def_campos['documentos'] = "documentos";
   $tab_labels["documentos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['labels']["documentos"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['labels']["documentos"] : "" . $this->Nm_lang['lang_documento'] . "";
   $tab_ger_campos['videos'] = "on";
   $tab_def_campos['videos'] = "videos";
   $tab_labels["videos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['labels']["videos"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['labels']["videos"] : "" . $this->Nm_lang['lang_video'] . "";
   $tab_ger_campos['paginas_sugeridas'] = "on";
   $tab_def_campos['paginas_sugeridas'] = "paginas_sugeridas";
   $tab_labels["paginas_sugeridas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['labels']["paginas_sugeridas"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['labels']["paginas_sugeridas"] : "" . $this->Nm_lang['lang_paginas'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tb_insumos_x_cursos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tb_insumos_x_cursos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
