...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["vrcrenewable_____grid_tb_insumos_x_cursos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["vrcrenewable_____grid_tb_insumos_x_cursos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['app_form_add_users'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tb_insumos_x_cursos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tb_insumos_x_cursos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tb_insumos_x_cursos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tb_insumos_x_cursos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tb_insumos_x_cursos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tb_insumos_x_cursos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tb_insumos_x_cursos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tb_insumos_x_cursos']['embutida_filho'] as $ind => $sc_init)
          {
