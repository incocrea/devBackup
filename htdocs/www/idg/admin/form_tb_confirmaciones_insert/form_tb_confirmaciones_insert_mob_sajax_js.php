  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_confirmaciones_insert_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_confirmaciones_insert_mob_form();
	}
...
?>
  ...
  // ---------- Validate codigoverificacion
  function do_ajax_form_tb_confirmaciones_insert_mob_validate_codigoverificacion()
  {
    var nomeCampo_codigoverificacion = "codigoverificacion";
    var var_codigoverificacion = scAjaxGetFieldText(nomeCampo_codigoverificacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_confirmaciones_insert_mob_validate_codigoverificacion(var_codigoverificacion, var_script_case_init, do_ajax_form_tb_confirmaciones_insert_mob_validate_codigoverificacion_cb);
  } // do_ajax_form_tb_confirmaciones_insert_mob_validate_codigoverificacion

  function do_ajax_form_tb_confirmaciones_insert_mob_validate_codigoverificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigoverificacion";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_confirmaciones_insert_mob_validate_codigoverificacion_cb

  // ---------- Validate institucion
  function do_ajax_form_tb_confirmaciones_insert_mob_validate_institucion()
  {
    var nomeCampo_institucion = "institucion";
    var var_institucion = scAjaxGetFieldSelect(nomeCampo_institucion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_confirmaciones_insert_mob_validate_institucion(var_institucion, var_script_case_init, do_ajax_form_tb_confirmaciones_insert_mob_validate_institucion_cb);
  } // do_ajax_form_tb_confirmaciones_insert_mob_validate_institucion

  function do_ajax_form_tb_confirmaciones_insert_mob_validate_institucion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_confirmaciones_insert_mob_validate_institucion_cb

  // ---------- Validate clixcur_id
  function do_ajax_form_tb_confirmaciones_insert_mob_validate_clixcur_id()
  {
    var nomeCampo_clixcur_id = "clixcur_id";
    var var_clixcur_id = scAjaxGetFieldSelect(nomeCampo_clixcur_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_confirmaciones_insert_mob_validate_clixcur_id(var_clixcur_id, var_script_case_init, do_ajax_form_tb_confirmaciones_insert_mob_validate_clixcur_id_cb);
  } // do_ajax_form_tb_confirmaciones_insert_mob_validate_clixcur_id

  function do_ajax_form_tb_confirmaciones_insert_mob_validate_clixcur_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "clixcur_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_confirmaciones_insert_mob_validate_clixcur_id_cb

  // ---------- Validate url
  function do_ajax_form_tb_confirmaciones_insert_mob_validate_url()
  {
    var nomeCampo_url = "url";
    var var_url = scAjaxGetFieldText(nomeCampo_url);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_confirmaciones_insert_mob_validate_url(var_url, var_script_case_init, do_ajax_form_tb_confirmaciones_insert_mob_validate_url_cb);
  } // do_ajax_form_tb_confirmaciones_insert_mob_validate_url

  function do_ajax_form_tb_confirmaciones_insert_mob_validate_url_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "url";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_confirmaciones_insert_mob_validate_url_cb

  // ---------- Validate activo
  function do_ajax_form_tb_confirmaciones_insert_mob_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldCheckbox(nomeCampo_activo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_confirmaciones_insert_mob_validate_activo(var_activo, var_script_case_init, do_ajax_form_tb_confirmaciones_insert_mob_validate_activo_cb);
  } // do_ajax_form_tb_confirmaciones_insert_mob_validate_activo

  function do_ajax_form_tb_confirmaciones_insert_mob_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_confirmaciones_insert_mob_validate_activo_cb

  // ---------- Refresh institucion
  function do_ajax_form_tb_confirmaciones_insert_mob_refresh_institucion()
  {
    var var_institucion = scAjaxGetFieldSelect("institucion");
    var var_nmgp_refresh_fields = "clixcur_id";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tb_confirmaciones_insert_mob_refresh_institucion(var_institucion, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_tb_confirmaciones_insert_mob_refresh_institucion_cb);
  } // do_ajax_form_tb_confirmaciones_insert_mob_refresh_institucion

  function do_ajax_form_tb_confirmaciones_insert_mob_refresh_institucion_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_confirmaciones_insert_mob_refresh_institucion_cb

  // ---------- Event onchange clixcur_id
  function do_ajax_form_tb_confirmaciones_insert_mob_event_clixcur_id_onchange()
  {
    var var_url = scAjaxGetFieldText("url");
    var var_clixcur_id = scAjaxGetFieldSelect("clixcur_id");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tb_confirmaciones_insert_mob_event_clixcur_id_onchange(var_url, var_clixcur_id, var_script_case_init, do_ajax_form_tb_confirmaciones_insert_mob_event_clixcur_id_onchange_cb);
  } // do_ajax_form_tb_confirmaciones_insert_mob_event_clixcur_id_onchange

  function do_ajax_form_tb_confirmaciones_insert_mob_event_clixcur_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "clixcur_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tb_confirmaciones_insert_mob_event_clixcur_id_onchange_cb_after_alert);
  } // do_ajax_form_tb_confirmaciones_insert_mob_event_clixcur_id_onchange_cb
  function do_ajax_form_tb_confirmaciones_insert_mob_event_clixcur_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_tb_confirmaciones_insert_mob_event_clixcur_id_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_confirmaciones_insert_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_confirmaciones_insert_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_codigoverificacion = scAjaxGetFieldText("codigoverificacion");
    var var_institucion = scAjaxGetFieldSelect("institucion");
    var var_clixcur_id = scAjaxGetFieldSelect("clixcur_id");
    var var_url = scAjaxGetFieldText("url");
    var var_activo = scAjaxGetFieldCheckbox("activo", ";");
    var var_confirmacion_id = scAjaxGetFieldText("confirmacion_id");
    ...
    scAjaxProcOn();
    x_ajax_form_tb_confirmaciones_insert_mob_submit_form(var_codigoverificacion, var_institucion, var_clixcur_id, var_url, var_activo, var_confirmacion_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_confirmaciones_insert_mob_submit_form_cb);
  } // do_ajax_form_tb_confirmaciones_insert_mob_submit_form

  function do_ajax_form_tb_confirmaciones_insert_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("codigoverificacion");
      scAjaxHideErrorDisplay("institucion");
      scAjaxHideErrorDisplay("clixcur_id");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_confirmaciones_insert_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tb_confirmaciones_insert_mob_submit_form_cb
  function do_ajax_form_tb_confirmaciones_insert_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_confirmaciones_insert_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_confirmaciones_insert_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_confirmaciones_insert_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_confirmaciones_insert_mob_navigate_form();
    }
  }

  function perform_ajax_form_tb_confirmaciones_insert_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("url");
    scAjaxHideErrorDisplay("activo");
    var var_confirmacion_id = document.F2.confirmacion_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tb_confirmaciones_insert_mob_navigate_form(var_confirmacion_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_confirmaciones_insert_mob_navigate_form_cb);
  } // do_ajax_form_tb_confirmaciones_insert_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_confirmaciones_insert_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_confirmaciones_insert_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.confirmacion_id.value = scAjaxGetKeyValue("confirmacion_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_confirmaciones_insert_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_confirmaciones_insert_mob_navigate_form_cb
  function do_ajax_form_tb_confirmaciones_insert_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tb_confirmaciones_insert_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_confirmaciones_insert_mob_navigate_form_cb_after_alert

  function sc_hide_form_tb_confirmaciones_insert_mob_form()
  {
  ...
  ajax_field_list[0] = "codigoverificacion";
  ajax_field_list[1] = "institucion";
  ajax_field_list[2] = "clixcur_id";
  ajax_field_list[3] = "url";
  ...
  var ajax_error_list = {
    "codigoverificacion": {"label": "Código Verificación", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "clixcur_id": {"label": "Alumno", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "url": {"label": "Url", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "activo": {"label": "Habilitar Diploma", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "codigoverificacion": new Array(),
    "institucion": new Array(),
    "clixcur_id": new Array(),
    "url": new Array(),
    "activo": new Array()
  };
  ajax_field_mult["codigoverificacion"][1] = "codigoverificacion";
  ajax_field_mult["institucion"][1] = "institucion";
  ajax_field_mult["clixcur_id"][1] = "clixcur_id";
  ajax_field_mult["url"][1] = "url";
  ajax_field_mult["activo"][1] = "activo";

  var ajax_field_id = {
    "codigoverificacion": new Array("hidden_field_label_codigoverificacion", "hidden_field_data_codigoverificacion"),
    "institucion": new Array("hidden_field_label_institucion", "hidden_field_data_institucion"),
    "clixcur_id": new Array("hidden_field_label_clixcur_id", "hidden_field_data_clixcur_id"),
