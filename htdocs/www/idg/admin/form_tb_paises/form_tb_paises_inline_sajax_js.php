  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_paises_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tb_paises_inline_form();
	}
...
?>
  ...
  // ---------- Validate pais_
  function do_ajax_form_tb_paises_inline_validate_pais_()
  {
    var nomeCampo_pais_ = "pais_";
    var var_pais_ = scAjaxGetFieldText(nomeCampo_pais_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_paises_inline_validate_pais_(var_pais_, var_script_case_init, do_ajax_form_tb_paises_inline_validate_pais__cb);
  } // do_ajax_form_tb_paises_inline_validate_pais_

  function do_ajax_form_tb_paises_inline_validate_pais__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_paises_inline_validate_pais__cb

  // ---------- Validate id_pais_
  function do_ajax_form_tb_paises_inline_validate_id_pais_()
  {
    var nomeCampo_id_pais_ = "id_pais_";
    var var_id_pais_ = scAjaxGetFieldText(nomeCampo_id_pais_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_paises_inline_validate_id_pais_(var_id_pais_, var_script_case_init, do_ajax_form_tb_paises_inline_validate_id_pais__cb);
  } // do_ajax_form_tb_paises_inline_validate_id_pais_

  function do_ajax_form_tb_paises_inline_validate_id_pais__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_paises_inline_validate_id_pais__cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tb_paises_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tb_paises_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pais_ = scAjaxGetFieldText("pais_");
    var var_id_pais_ = scAjaxGetFieldText("id_pais_");
    ...
    scAjaxProcOn();
    x_ajax_form_tb_paises_inline_submit_form(var_pais_, var_id_pais_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_paises_inline_submit_form_cb);
  } // do_ajax_form_tb_paises_inline_submit_form

  function do_ajax_form_tb_paises_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pais_");
      scAjaxHideErrorDisplay("id_pais_");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tb_paises_inline_submit_form_cb_after_alert);
  } // do_ajax_form_tb_paises_inline_submit_form_cb
  function do_ajax_form_tb_paises_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_paises_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_paises_inline_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_paises_inline_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_paises_inline_navigate_form();
    }
  }

  function perform_ajax_form_tb_paises_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tb_paises_inline_navigate_form(var_id_pais_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_paises_inline_navigate_form_cb);
  } // do_ajax_form_tb_paises_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_paises_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_paises_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_paises_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_paises_inline_navigate_form_cb
  function do_ajax_form_tb_paises_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tb_paises_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tb_paises_inline_navigate_form_cb_after_alert

  function sc_hide_form_tb_paises_inline_form()
  {
  ...
  ajax_field_list[0] = "pais_";
  ajax_field_list[1] = "id_pais_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "pais_": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_paises_fld_Pais'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_pais_": {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_paises_fld_Id_Pais'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["pais_"][1] = "pais_";
  ajax_field_mult["id_pais_"][1] = "id_pais_";

  var ajax_field_id = {
    "pais_": new Array("hidden_field_label_pais_", "hidden_field_data_pais_")
  };
