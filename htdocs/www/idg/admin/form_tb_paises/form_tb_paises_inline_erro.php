...
$old_error_handler = set_error_handler("form_tb_paises_inline_scriptcase_error_handler");

function form_tb_paises_inline_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['form_tb_paises_inline']['contr_erro']) && $_SESSION['scriptcase']['form_tb_paises_inline']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_tb_paises_inline->contr_form_tb_paises_inline->Apl_com_erro = true;
            if ($inicial_form_tb_paises_inline->contr_form_tb_paises_inline->NM_ajax_flag)
            {
                $inicial_form_tb_paises_inline->contr_form_tb_paises_inline->NM_ajax_info['errList']['geral_form_tb_paises_inline'][] = $msg;
                return;
            }
            form_tb_paises_inline_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_tb_paises_inline_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tb_paises_inline'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tb_paises_inline'])  ? $_SESSION['scriptcase']['error_icon']['form_tb_paises_inline']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tb_paises_inline']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tb_paises_inline']) ? $_SESSION['scriptcase']['error_span_title']['form_tb_paises_inline'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tb_paises_inline']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tb_paises_inline']) ? $_SESSION['scriptcase']['error_icon_title']['form_tb_paises_inline'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_tb_paises']['error_buffer'] .= ob_get_flush();
}
