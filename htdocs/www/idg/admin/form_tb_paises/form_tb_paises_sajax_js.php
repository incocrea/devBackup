  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tb_paises" == sTestField)
        {
...
?>
  ...
  // ---------- Validate pais_
  function do_ajax_form_tb_paises_validate_pais_(iNumLinha)
  {
    var nomeCampo_pais_ = "pais_" + iNumLinha;
    var var_pais_ = scAjaxGetFieldText(nomeCampo_pais_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_paises_validate_pais_(var_pais_, iNumLinha, var_script_case_init, do_ajax_form_tb_paises_validate_pais__cb);
  } // do_ajax_form_tb_paises_validate_pais_

  function do_ajax_form_tb_paises_validate_pais__cb(sResp)
  {
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "pais_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pais_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_paises_validate_pais__cb

  // ---------- Validate id_pais_
  function do_ajax_form_tb_paises_validate_id_pais_(iNumLinha)
  {
    var nomeCampo_id_pais_ = "id_pais_" + iNumLinha;
    var var_id_pais_ = scAjaxGetFieldHidden(nomeCampo_id_pais_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_paises_validate_id_pais_(var_id_pais_, iNumLinha, var_script_case_init, do_ajax_form_tb_paises_validate_id_pais__cb);
  } // do_ajax_form_tb_paises_validate_id_pais_

  function do_ajax_form_tb_paises_validate_id_pais__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_pais_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_pais_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_pais_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_pais_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tb_paises_validate_id_pais__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tb_paises_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tb_paises_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tb_paises_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tb_paises_add_new_line_cb);
  } // do_ajax_form_tb_paises_add_new_line

  function do_ajax_form_tb_paises_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tb_paises_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tb_paises_backup_line(iNumLinha)
  {
    var var_id_pais_ = scAjaxGetFieldHidden("id_pais_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tb_paises_backup_line(var_id_pais_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tb_paises_backup_line_cb);
  } // do_ajax_form_tb_paises_backup_line

  function do_ajax_form_tb_paises_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tb_paises_backup_line_cb

  function do_ajax_form_tb_paises_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tb_paises_cancel_insert

  function do_ajax_form_tb_paises_cancel_update(iSeqVert)
  {
    do_ajax_form_tb_paises_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tb_paises_cancel_update

  function do_ajax_form_tb_paises_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tb_paises_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tb_paises_table_refresh()
  {
    var var_id_pais_ = document.F2.id_pais_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tb_paises_table_refresh(var_id_pais_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_paises_table_refresh_cb);
  } //  do_ajax_form_tb_paises_table_refresh

  function do_ajax_form_tb_paises_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_pais_.value = scAjaxGetKeyValue("id_pais_");
    ...
    scAjaxAlert(do_ajax_form_tb_paises_table_refresh_cb_after_alert);
  } // do_ajax_form_tb_paises_table_refresh_cb
  function do_ajax_form_tb_paises_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tb_paises_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tb_paises_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tb_paises_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_pais_ = scAjaxGetFieldText("pais_" + iNumLinha);
    var var_id_pais_ = scAjaxGetFieldHidden("id_pais_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tb_paises_submit_form(var_pais_, var_id_pais_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tb_paises_submit_form_cb);
  } // do_ajax_form_tb_paises_submit_form

  function do_ajax_form_tb_paises_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pais_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("id_pais_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tb_paises_submit_form_cb_after_alert);
  } // do_ajax_form_tb_paises_submit_form_cb
  function do_ajax_form_tb_paises_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tb_paises_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tb_paises_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tb_paises_navigate_form, function() {});
    } else {
      perform_ajax_form_tb_paises_navigate_form();
    }
  }

  function perform_ajax_form_tb_paises_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tb_paises_cancel_insert(sc_form_tb_paises_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("pais_" + iNavForm);
      scAjaxHideErrorDisplay("id_pais_" + iNavForm);
    }
    var var_id_pais_ = document.F2.id_pais_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tb_paises_navigate_form(var_id_pais_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tb_paises_navigate_form_cb);
  } // do_ajax_form_tb_paises_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tb_paises']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tb_paises_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_pais_.value = scAjaxGetKeyValue("id_pais_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tb_paises_navigate_form_cb_after_alert);
  } // do_ajax_form_tb_paises_navigate_form_cb
  function do_ajax_form_tb_paises_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tb_paises_navigate_form_cb_after_alert

    function sc_form_tb_paises_get_last_line_number()
    {
    ...
    } //sc_form_tb_paises_get_last_line_number

  function sc_hide_form_tb_paises_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "pais_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_pais_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["pais_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_paises_fld_Pais'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["id_pais_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tb_paises_fld_Id_Pais'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["pais_"][iNumLinha] = "pais_" + iNumLinha;
    ajax_field_mult["id_pais_"][iNumLinha] = "id_pais_" + iNumLinha;
    ajax_field_id["pais_" + iNumLinha] = new Array("hidden_field_label_pais_", "hidden_field_data_pais_" + iNumLinha);
    ajax_error_count["pais_" + iNumLinha] = "off";
    ajax_error_count["id_pais_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["pais_" + iNumLinha] = "off";
    ajax_read_only["id_pais_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["pais_" + iNumLinha] = "on";
    ajax_read_only["id_pais_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["pais_" + iNumLinha] = null;
    ajax_error_list["id_pais_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["pais_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pais_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pais_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pais_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pais_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["id_pais_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_pais_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_pais_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_pais_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_pais_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pais_'])) ? $this->nmgp_cmp_readonly['pais_'] : 'off';
?>
    scAjaxFieldRead("pais_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_pais_'])) ? $this->nmgp_cmp_readonly['id_pais_'] : 'on';
?>
    scAjaxFieldRead("id_pais_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("pais_" + iSeq, "on");
    scAjaxFieldRead("id_pais_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["pais_" + iRow] || "on" == ajax_error_count["id_pais_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pais_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_pais_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["pais_" + iRow] && "off" == ajax_error_count["id_pais_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["pais_" + iRow] = "off";
        ajax_error_count["id_pais_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_pais_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_id_pais_" + iRow).removeClass("scFormErrorLine");
    }
  }
