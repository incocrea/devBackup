...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["vrcrenewable_____grid_tb_certificados"]))
   {
      unset($_SESSION['session_sec_aplicacao']["vrcrenewable_____grid_tb_certificados"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tb_certificados'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tb_certificados']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tb_certificados']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tb_certificados']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tb_certificados']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tb_certificados']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tb_certificados</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tb_certificados']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tb_certificados']['embutida_filho'] as $ind => $sc_init)
          {
