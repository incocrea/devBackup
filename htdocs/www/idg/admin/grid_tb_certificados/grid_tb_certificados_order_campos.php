...
<?php
   ...
   $Ord_Cmp = new grid_tb_certificados_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tb_certificados_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['enlace_imagen'] = "Enlace_imagen";
   $tab_labels["enlace_imagen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['labels']["enlace_imagen"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['labels']["enlace_imagen"] : "" . $this->Nm_lang['lang_tb_certificados_fld_Enlace_imagen'] . "";
   $tab_ger_campos['informacion'] = "on";
   $tab_def_campos['informacion'] = "Informacion";
   $tab_labels["informacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['labels']["informacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['labels']["informacion"] : "" . $this->Nm_lang['lang_tb_certificados_fld_Informacion'] . "";
   $tab_ger_campos['modalidad'] = "on";
   $tab_def_campos['modalidad'] = "Modalidad";
   $tab_labels["modalidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['labels']["modalidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['labels']["modalidad"] : "" . $this->Nm_lang['lang_tb_certificados_fld_Modalidad'] . "";
   $tab_ger_campos['activo'] = "on";
   $tab_def_campos['activo'] = "Activo";
   $tab_labels["activo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['labels']["activo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['labels']["activo"] : "" . $this->Nm_lang['lang_tb_certificados_fld_Activo'] . "";
   $tab_ger_campos['curxinst_id'] = "on";
   $tab_def_campos['curxinst_id'] = "Curxinst_id";
   $tab_labels["curxinst_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['labels']["curxinst_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['labels']["curxinst_id"] : "" . $this->Nm_lang['lang_tb_certificados_fld_Curxinst_id'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tb_certificados_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tb_certificados']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
