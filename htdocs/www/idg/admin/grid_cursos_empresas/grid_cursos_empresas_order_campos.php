<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_cursos_empresas']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_cursos_empresas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cursos_empresas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['course_title'] = "on";
   $tab_def_campos['course_title'] = "course_title";
   $tab_labels["course_title"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["course_title"])) ? $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["course_title"] : "Course Title";
   $tab_ger_campos['course_lenght'] = "on";
   $tab_def_campos['course_lenght'] = "course_lenght";
   $tab_labels["course_lenght"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["course_lenght"])) ? $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["course_lenght"] : "Course Lenght";
   $tab_ger_campos['course_lang'] = "on";
   $tab_def_campos['course_lang'] = "course_lang";
   $tab_labels["course_lang"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["course_lang"])) ? $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["course_lang"] : "Course Lang";
   $tab_ger_campos['course_img'] = "on";
   $tab_def_campos['course_img'] = "course_img";
   $tab_labels["course_img"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["course_img"])) ? $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["course_img"] : "Course Img";
   $tab_ger_campos['is_displayed'] = "on";
   $tab_def_campos['is_displayed'] = "is_displayed";
   $tab_labels["is_displayed"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["is_displayed"])) ? $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["is_displayed"] : "Is Displayed";
   $tab_ger_campos['fecha_inicio'] = "on";
   $tab_def_campos['fecha_inicio'] = "Fecha_inicio";
   $tab_labels["fecha_inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["fecha_inicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["fecha_inicio"] : "Fecha Inicio";
   $tab_ger_campos['fecha_terminacion'] = "on";
   $tab_def_campos['fecha_terminacion'] = "Fecha_terminacion";
   $tab_labels["fecha_terminacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["fecha_terminacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["fecha_terminacion"] : "Fecha Terminacion";
   $tab_ger_campos['estado_id'] = "on";
   $tab_def_campos['estado_id'] = "Estado_id";
   $tab_labels["estado_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["estado_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["estado_id"] : "Estado Id";
   $tab_ger_campos['id_institucion'] = "on";
   $tab_def_campos['id_institucion'] = "Id_institucion";
   $tab_labels["id_institucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["id_institucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["id_institucion"] : "Id Institucion";
   $tab_ger_campos['upload_participantes'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['upload_participantes'] = "upload_participantes";
   }
   else
   {
       $tab_def_campos['upload_participantes'] = "";
   }
   $tab_labels["upload_participantes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["upload_participantes"])) ? $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['labels']["upload_participantes"] : "upload_participantes";
   $tab_ger_campos['upload_participantes'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cursos_empresas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cursos_empresas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
