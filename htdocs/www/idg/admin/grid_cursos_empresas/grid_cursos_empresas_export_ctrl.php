<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cursos_empresas']['sc_process_barr'] = true;
require_once('../grid_cursos_empresas/index.php');
unset($_SESSION['scriptcase']['grid_cursos_empresas']['sc_process_barr']);
$ExportCtrl = new grid_cursos_empresas_export_control;
$ExportCtrl->Export_barr();

class grid_cursos_empresas_export_control
{
