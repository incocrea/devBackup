<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tb_insumos_x_cursos_1']['sc_process_barr'] = true;
require_once('../grid_tb_insumos_x_cursos_1/index.php');
unset($_SESSION['scriptcase']['grid_tb_insumos_x_cursos_1']['sc_process_barr']);
$ExportCtrl = new grid_tb_insumos_x_cursos_1_export_control;
$ExportCtrl->Export_barr();

class grid_tb_insumos_x_cursos_1_export_control
{
