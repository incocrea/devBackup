...
$path_apls     .= "/";
$this->str_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "VCR_menu/VCR_menu";
...
$this->str_schema_all = $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "VCR_menu/VCR_menu";
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tb_paises") . "/form_tb_paises_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tb_paises']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tb_documentosxpais") . "/grid_tb_documentosxpais_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_documentosxpais']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tb_estados") . "/form_tb_estados_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tb_estados']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tb_instituciones") . "/grid_tb_instituciones_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_instituciones']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tb_clientes") . "/grid_tb_clientes_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_clientes']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tb_clientesxcursos") . "/grid_tb_clientesxcursos_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_clientesxcursos']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tb_courses") . "/grid_tb_courses_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_courses']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_tb_courses'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tb_cursosxinstituciones") . "/grid_tb_cursosxinstituciones_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_cursosxinstituciones']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_cursos_empresas") . "/grid_cursos_empresas_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cursos_empresas']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_cursos_empresas'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("cursos_alumnos") . "/cursos_alumnos_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['cursos_alumnos']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['cursos_alumnos'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tb_certificados") . "/grid_tb_certificados_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_certificados']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tb_confirmaciones") . "/grid_tb_confirmaciones_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_confirmaciones']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("control_certificados") . "/control_certificados_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_certificados']))
    {
...
ob_end_clean();
 ...
 $nm_var_lab[0] = "Cursos Habilitados";
...
$app_menu_menuData['data'] .= "item_1|.|" . $this->Nm_lang['lang_parametros'] . "||" . $nm_var_hint[0] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tb_paises']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tb_paises']) == "on")
{
    $app_menu_menuData['data'] .= "item_2|..|" . $this->Nm_lang['lang_paises'] . "|app_menu_form_php.php?sc_item_menu=item_2&sc_apl_menu=form_tb_paises&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_documentosxpais']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_documentosxpais']) == "on")
{
    $app_menu_menuData['data'] .= "item_3|..|" . $this->Nm_lang['lang_doc_x_pais'] . "|app_menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=grid_tb_documentosxpais&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tb_estados']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tb_estados']) == "on")
{
    $app_menu_menuData['data'] .= "item_4|..|" . $this->Nm_lang['lang_estado'] . "|app_menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=form_tb_estados&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_instituciones']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_instituciones']) == "on")
{
    $app_menu_menuData['data'] .= "item_5|..|" . $this->Nm_lang['lang_empresas'] . "|app_menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=grid_tb_instituciones&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_clientes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_clientes']) == "on")
{
    $app_menu_menuData['data'] .= "item_6|..|" . $this->Nm_lang['lang_participantes'] . "|app_menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=grid_tb_clientes&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

$app_menu_menuData['data'] .= "item_7|.|" . $this->Nm_lang['lang_capacitaciones'] . "||" . $nm_var_hint[6] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_clientesxcursos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_clientesxcursos']) == "on")
{
    $app_menu_menuData['data'] .= "item_9|..|" . $this->Nm_lang['lang_participantes_x_capacitacion'] . "|app_menu_form_php.php?sc_item_menu=item_9&sc_apl_menu=grid_tb_clientesxcursos&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_courses']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_courses']) == "on")
{
    $app_menu_menuData['data'] .= "item_24|..|" . $this->Nm_lang['lang_cursos'] . "|app_menu_form_php.php?sc_item_menu=item_24&sc_apl_menu=grid_tb_courses&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_cursosxinstituciones']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_cursosxinstituciones']) == "on")
{
    $app_menu_menuData['data'] .= "item_8|..|" . $this->Nm_lang['lang_capacitaciones_x_empresa'] . "|app_menu_form_php.php?sc_item_menu=item_8&sc_apl_menu=grid_tb_cursosxinstituciones&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cursos_empresas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cursos_empresas']) == "on")
{
    $app_menu_menuData['data'] .= "item_25|.|" . $nm_var_lab[0] . "|app_menu_form_php.php?sc_item_menu=item_25&sc_apl_menu=grid_cursos_empresas&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[10] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['cursos_alumnos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['cursos_alumnos']) == "on")
{
    $app_menu_menuData['data'] .= "item_26|.|" . $this->Nm_lang['lang_mis_cursos'] . "|app_menu_form_php.php?sc_item_menu=item_26&sc_apl_menu=cursos_alumnos&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_certificados']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_certificados']) == "on")
{
    $app_menu_menuData['data'] .= "item_10|.|" . $this->Nm_lang['lang_parametrizar_certificados'] . "|app_menu_form_php.php?sc_item_menu=item_10&sc_apl_menu=grid_tb_certificados&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[12] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_confirmaciones']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_confirmaciones']) == "on")
{
    $app_menu_menuData['data'] .= "item_11|.|" . $this->Nm_lang['lang_activacion_diplomas'] . "|app_menu_form_php.php?sc_item_menu=item_11&sc_apl_menu=grid_tb_confirmaciones&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[13] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['control_certificados']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_certificados']) == "on")
{
    $app_menu_menuData['data'] .= "item_12|.|" . $this->Nm_lang['lang_mis_certificados'] . "|app_menu_form_php.php?sc_item_menu=item_12&sc_apl_menu=control_certificados&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[14] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

$app_menu_menuData['data'] .= "item_13|.|" . $this->Nm_lang['lang_menu_security'] . "||" . $this->Nm_lang['lang_menu_security'] . "||_self|\n";
...
{
    $app_menu_menuData['data'] .= "item_14|..|" . $this->Nm_lang['lang_list_users'] . "|app_menu_form_php.php?sc_item_menu=item_14&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) == "on")
{
    $app_menu_menuData['data'] .= "item_15|..|" . $this->Nm_lang['lang_list_apps'] . "|app_menu_form_php.php?sc_item_menu=item_15&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
...
{
    $app_menu_menuData['data'] .= "item_16|..|" . $this->Nm_lang['lang_list_groups'] . "|app_menu_form_php.php?sc_item_menu=item_16&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_groups'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
...
{
    $app_menu_menuData['data'] .= "item_23|..|" . $this->Nm_lang['lang_list_users_x_groups'] . "|app_menu_form_php.php?sc_item_menu=item_23&sc_apl_menu=app_grid_sec_users_groups&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users_x_groups'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
...
{
    $app_menu_menuData['data'] .= "item_17|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "|app_menu_form_php.php?sc_item_menu=item_17&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) == "on")
{
    $app_menu_menuData['data'] .= "item_18|..|" . $this->Nm_lang['lang_list_sync_apps'] . "|app_menu_form_php.php?sc_item_menu=item_18&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_sync_apps'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) == "on")
{
    $app_menu_menuData['data'] .= "item_19|..|" . $this->Nm_lang['lang_change_pswd'] . "|app_menu_form_php.php?sc_item_menu=item_19&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_change_pswd'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) == "on")
{
    $app_menu_menuData['data'] .= "item_20|.|" . $this->Nm_lang['lang_exit'] . "|app_menu_form_php.php?sc_item_menu=item_20&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_exit'] . "||" . $this->app_menu_target('_parent') . "|" . "\n";
}
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_2&sc_apl_menu=form_tb_paises&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tb_paises']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tb_paises']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $app_menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_paises'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[1] . "",
        'id'       => "item_2",
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=grid_tb_documentosxpais&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_documentosxpais']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_documentosxpais']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $app_menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_doc_x_pais'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[2] . "",
        'id'       => "item_3",
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=form_tb_estados&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tb_estados']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tb_estados']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $app_menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_estado'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[3] . "",
        'id'       => "item_4",
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=grid_tb_instituciones&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_instituciones']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_instituciones']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=grid_tb_clientes&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_clientes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_clientes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $app_menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_participantes'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[5] . "",
        'id'       => "item_6",
...
$app_menu_menuData['data'][] = array(
    'label'    => "" . $this->Nm_lang['lang_capacitaciones'] . "",
    'level'    => "0",
    'link'     => $str_link,
    'hint'     => "" . $nm_var_hint[6] . "",
    'id'       => "item_7",
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_9&sc_apl_menu=grid_tb_clientesxcursos&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_clientesxcursos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_clientesxcursos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $app_menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_participantes_x_capacitacion'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[7] . "",
        'id'       => "item_9",
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_24&sc_apl_menu=grid_tb_courses&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_courses']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_courses']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $app_menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_cursos'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[8] . "",
        'id'       => "item_24",
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_8&sc_apl_menu=grid_tb_cursosxinstituciones&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_cursosxinstituciones']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_cursosxinstituciones']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $app_menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_capacitaciones_x_empresa'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[9] . "",
        'id'       => "item_8",
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_25&sc_apl_menu=grid_cursos_empresas&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cursos_empresas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cursos_empresas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_26&sc_apl_menu=cursos_alumnos&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['cursos_alumnos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['cursos_alumnos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $app_menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_mis_cursos'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[11] . "",
        'id'       => "item_26",
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_10&sc_apl_menu=grid_tb_certificados&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_certificados']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_certificados']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $app_menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_parametrizar_certificados'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[12] . "",
        'id'       => "item_10",
        ...
        'display'     => "text_fontawesomeicon",
        'display_position'=> "text_right",
        'icon_fa'     => "fas fa-certificate",
        'icon_color'     => "",
        'icon_color_hover'     => "",
        'icon_color_disabled'     => "",
    );
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_11&sc_apl_menu=grid_tb_confirmaciones&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_confirmaciones']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tb_confirmaciones']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $app_menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_activacion_diplomas'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[13] . "",
        'id'       => "item_11",
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_12&sc_apl_menu=control_certificados&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_certificados']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_certificados']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $app_menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_mis_certificados'] . "",
        'level'    => "0",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[14] . "",
        'id'       => "item_12",
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_14&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_15&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_16&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_23&sc_apl_menu=app_grid_sec_users_groups&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_17&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_18&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_19&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_20&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
<style>
   .scTabText {
   }   #item_25 .icon_fa{ color: #0fab7d  !important}
    <?php
...
<table width="100%" height="67px" class="scMenuHHeader">
        <tr>
                <td width="5px"></td>
        <td width="67px" class="scMenuHHeaderFont">   <IMG SRC="<?php echo $path_imag_cab ?>/grp__NM__img__NM__Logo-proyecto.png" BORDER="0"/></td>
...
?>
        <td class='sc-layer-0' style='width:6.3%;text-align:left;'>
                        <span class='sc-layer-0-0' style='font-size: 16px;background-color: ;font-family: ;color: #000000;'><?php echo "" . $_SESSION['par_cliente_id'] . "" ?></span><br/>
  ...
  <div class='mainmenu menu--horizontal'>
      ...
      <div class='menu__container '>
        ...
        <td class='sc-layer-4' style='width:7%;text-align:left;'>
                        <span class='sc-layer-4-0' style='font-size: 16px;background-color: ;font-family: ;color: #000000;'><?php echo "Usuario: " ?></span><br/>
            <span class='sc-layer-4-1' style='font-size: 16px;background-color: ;font-family: ;color: #000000;'><?php echo "" . $_SESSION['usr_name'] . "" ?></span><br/>
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['app_menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_vrcrenewable.txt"));
    }
    if (isset($apl_def)) {
        ...
        if (isset($_COOKIE['sc_actual_lang_vrcrenewable'])) {
            $_SESSION['scriptcase']['app_menu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_vrcrenewable'];
        }
    }
}
