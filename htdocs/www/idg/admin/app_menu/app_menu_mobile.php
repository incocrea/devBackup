...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>VCR_menu/VCR_menu_menuMobile.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>VCR_menu/VCR_menu_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
