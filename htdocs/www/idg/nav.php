        ...
        <div class="container"><a class="navbar-brand" href="index.php"><img src="assets/img/Logo-proyecto.png" width="" height="80" alt=""/>
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle p-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><?php echo $lang['Idioma_activo'] ?><svg xmlns="http://www.w3.org/2000/svg" width="10" height="6" fill="none">
                    ...
                    <ul class="dropdown-menu rounded-2 shadow">
                        <li class="nav-item"><a class="nav-link active" href="index.php?lang=en"><?php echo $lang['en'] ?></a></li>
                        <li class="nav-item"><a class="nav-link" href="index.php?lang=es"><?php echo $lang['es'] ?></a></li>
                        <li class="nav-item"><a class="nav-link" href="index.php?lang=po"><?php echo $lang['po'] ?></a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item navbar-dropdown"><a href="admin/" target="_blank" class="nav-link"><span><?php echo $lang['Customers'] ?></span></a>
                    <!--
                    <div class="dropdown-menu rounded-2 shadow">
                        <ul class="nav navbar-nav">
                ...
                <li class="nav-item navbar-dropdown"><a class="nav-link" href="mailto:app/login.html"><span><?php echo $lang['Contact'] ?></span></a>
                    <!--
                    <div class="dropdown-menu rounded-2 shadow">
                        <ul class="nav navbar-nav">
    ...
    <div class="navbar navbar-mobile navbar-mobile-style-1 bg-white mfp-hide" id="navbar-mobile-style-1">
        <div class="navbar-wrapper">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle p-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><?php echo $lang['Idioma_activo'] ?><svg xmlns="http://www.w3.org/2000/svg" width="10" height="6" fill="none">
                    ...
                    <li class="nav-item "><a class="nav-link" href="admin/" target="_blank"><span><?php echo $lang['Customers'] ?></span></a>                        
                    </li>
                     <li class="nav-item "><a class="nav-link" href="mailto:app/login.html" target="_blank"><span><?php echo $lang['Contact'] ?></span></a>                        
                    </li>   
                    </li>
                </ul>
            </div>
            <div class="navbar-footer">
                ...
                <ul class="list-group borderless font-size-15">
                    <li class="list-group-item">Email: <a href="mailto:mailto:app/login.html">mailto:app/login.html</a></li>
