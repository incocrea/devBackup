<?php
	...
	$destination_path = "/home/jmmdy48n8trq/public_html/trfiles/";
	
	 // $destination_path = "/xampp/htdocs/www/quoting/trfiles/";
	...
	// RETURN TO JS
	echo '<script language="javascript" type="text/javascript">window.top.window.loadFinishD("'.$result.'");</script> ';
?>