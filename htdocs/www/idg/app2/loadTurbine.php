<?php
	...
	$destination_path = "/home/jmmdy48n8trq/public_html/filesT/";
	
	 // $destination_path = "/xampp/htdocs/www/quoting/filesT/";
	...
	// RETURN TO JS
	echo '<script language="javascript" type="text/javascript">window.top.window.loadFinishT("'.$result.'");</script> ';
?>