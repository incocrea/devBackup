...
function formBox2(content, title, wide)
{
	var modal = document.getElementById("modalCover2");
	modal.className = "modalCoverForm2";
	$("#modalCover2").fadeIn(100);
	modal.style.display = "block";
	var modalTitle =  document.getElementById("modalTitle2");
	modalTitle.innerHTML = title;
	var modalSubTitle =  document.getElementById("modalSubTitle2");
	var modalArea = document.getElementById("modal2");
	var modalContainer = document.getElementById("modalContent2");
	var modalContent = document.getElementById(content);
...
function alertBox(title,content,wide,aTxt)
{
	...
	if(specialForm != "")
	{
		if(specialForm = "standBy")
		{
			aceptb.onclick = saveActualSTB;
		}
...
function hide_pop_form()
{
	...
	actualEtype = "";
	if(document.getElementById("dayObs"))
	{
		document.getElementById("dayObs").innerHTML = "";
	}
}
function hide_pop()
{
...
function hide_pop_form2()
{
	var modal = document.getElementById("modalCover2");
	$("#modalCover2").fadeOut(100);
