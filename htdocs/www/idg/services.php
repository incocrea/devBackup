        ...
        <div class="container"><a class="navbar-brand" href="index.php"><img src="assets/img/Logo-proyecto.png" width="" height="80" alt=""/>
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle p-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><?php echo $lang['Idioma_activo'] ?><svg xmlns="http://www.w3.org/2000/svg" width="10" height="6" fill="none">
                    ...
                    <ul class="dropdown-menu rounded-2 shadow">
                        <li class="nav-item"><a class="nav-link active" href="services.php?lang=en"><?php echo $lang['en'] ?></a></li>
                        <li class="nav-item"><a class="nav-link" href="services.php?lang=es"><?php echo $lang['es'] ?></a></li>
                        <li class="nav-item"><a class="nav-link" href="services.php?lang=po"><?php echo $lang['po'] ?></a></li>
                    </ul>
                </li>
    ...
    <div class="content-wrap ">
        ...
        <div class="position-relative py-210">
            <div class="background">
                <div class="background-image jarallax" data-jarallax data-speed="0.8"><img class="jarallax-img" loading="lazy" src="assets/img/servicios.jpg" alt=""></div>
                <div class="background-color" style="--background-color: #000; opacity: .25;"></div>
            </div>
            <div class="container">
                <h1 class="text-white mb-0 text-center"><?php echo $lang['Title_slide'] ?></h1>
            </div>
        </div>
        <div id="services" class="pt-120 pb-130">
            <div class="container">
                <div class="row mb-90">
                    <div class="col-lg-6 offset-lg-3 text-center">
                        <h3 class="m-0" data-show="startbox"><?php echo $lang['S_service1'] ?> <span ><?php echo $lang['S_service2'] ?></span> <?php echo $lang['S_service3'] ?>.</h3>
                    </div>
                </div>
                <div class="row gy-30">
                    ...
                    <div class="col-12 col-lg-6" data-show="startbox">
                        ...
                        <div class="service-card lift position-relative bg-light rounded-4 overflow-hidden">
                            <div class="service-card-image flex-shrink-0" data-img-height style="--img-height: 100%;"><img loading="lazy" src="assets/img/interfas.jpg" alt=""></div>
                            <div class="service-card-body flex-grow-1">
                                <h4 class="service-card-title mb-15"><?php echo $lang['Titulo1_s'] ?></h4>
                                <p class="service-card-text font-size-15 mb-30"><?php echo $lang['Descripcion1_s'] ?></p><a class="service-card-arrow stretched-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                    ...
                    <div class="col-12 col-lg-6" data-show="startbox" data-show-delay="100">
                        ...
                        <div class="service-card lift position-relative bg-light rounded-4 overflow-hidden">
                            <div class="service-card-image flex-shrink-0" data-img-height style="--img-height: 100%;"><img loading="lazy" src="assets/img/almacenamiento.jpg" alt=""></div>
                            <div class="service-card-body flex-grow-1">
                                <h4 class="service-card-title mb-15"><?php echo $lang['Titulo_2_s'] ?></h4>
                                <p class="service-card-text font-size-15 mb-30"><?php echo $lang['Descripcion_2_s'] ?></p><a class="service-card-arrow stretched-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                                        <path stroke="currentColor" stroke-width="1.7" d="M0 7h18m0 0-6.75-6M18 7l-6.75 6" />
                                    </svg></a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-lg-6" data-show="startbox">
                        ...
                        <div class="service-card lift position-relative bg-light rounded-4 overflow-hidden">
                            <div class="service-card-image flex-shrink-0" data-img-height style="--img-height: 100%;"><img loading="lazy" src="assets/img/capacitacion.jpg" alt=""></div>
                            <div class="service-card-body flex-grow-1">
                                <h4 class="service-card-title mb-15"><?php echo $lang['Titulo3_s'] ?></h4>
                                <p class="service-card-text font-size-15 mb-30"><?php echo $lang['Descripcion3_s'] ?>
</p><a class="service-card-arrow stretched-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                                        <path stroke="currentColor" stroke-width="1.7" d="M0 7h18m0 0-6.75-6M18 7l-6.75 6" />
                                    </svg></a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-lg-6" data-show="startbox" data-show-delay="100">
                        ...
                        <div class="service-card lift position-relative bg-light rounded-4 overflow-hidden">
                            <div class="service-card-image flex-shrink-0" data-img-height style="--img-height: 100%;"><img loading="lazy" src="assets/img/Inspections1.jpg" alt=""></div>
                            <div class="service-card-body flex-grow-1">
                                <h4 class="service-card-title mb-15"><?php echo $lang['Titulo4_s'] ?></h4>
                                <p class="service-card-text font-size-15 mb-30"><?php echo $lang['Descripcion4_s'] ?></p><a class="service-card-arrow stretched-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                                        <path stroke="currentColor" stroke-width="1.7" d="M0 7h18m0 0-6.75-6M18 7l-6.75 6" />
                                    </svg></a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-lg-6" data-show="startbox" data-show-delay="100">
                        ...
                        <div class="service-card lift position-relative bg-light rounded-4 overflow-hidden">
                            <div class="service-card-image flex-shrink-0" data-img-height style="--img-height: 100%;"><img loading="lazy" src="assets/img/safety.jpg" alt=""></div>
                            <div class="service-card-body flex-grow-1">
                                <h4 class="service-card-title mb-15"><?php echo $lang['Titulo5_s'] ?></h4>
                                <p class="service-card-text font-size-15 mb-30"><?php echo $lang['Titulo5_s'] ?></p><a class="service-card-arrow stretched-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                                        <path stroke="currentColor" stroke-width="1.7" d="M0 7h18m0 0-6.75-6M18 7l-6.75 6" />
                                    </svg></a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-lg-6" data-show="startbox" data-show-delay="100">
                        ...
                        <div class="service-card lift position-relative bg-light rounded-4 overflow-hidden">
                            <div class="service-card-image flex-shrink-0" data-img-height style="--img-height: 100%;"><img loading="lazy" src="assets/img/blade.jpg" alt=""></div>
                            <div class="service-card-body flex-grow-1">
                                <h4 class="service-card-title mb-15"><?php echo $lang['Titulo6_s'] ?></h4>
                                <p class="service-card-text font-size-15 mb-30"><?php echo $lang['Descripcion6_s'] ?></p><a class="service-card-arrow stretched-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                                        <path stroke="currentColor" stroke-width="1.7" d="M0 7h18m0 0-6.75-6M18 7l-6.75 6" />
                                    </svg></a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-lg-6" data-show="startbox" data-show-delay="100">
                        ...
                        <div class="service-card lift position-relative bg-light rounded-4 overflow-hidden">
                            <div class="service-card-image flex-shrink-0" data-img-height style="--img-height: 100%;"><img loading="lazy" src="assets/img/drone.jpg" alt=""></div>
                            <div class="service-card-body flex-grow-1">
                                <h4 class="service-card-title mb-15"><?php echo $lang['Titulo7_s'] ?></h4>
                                <p class="service-card-text font-size-15 mb-30"><?php echo $lang['Descripcion7_s'] ?></p><a class="service-card-arrow stretched-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                                        <path stroke="currentColor" stroke-width="1.7" d="M0 7h18m0 0-6.75-6M18 7l-6.75 6" />
                                    </svg></a>
                            </div>
                        </div>
