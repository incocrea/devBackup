        ...
        <div class="container"><a class="navbar-brand" href="index.php"><img src="assets/img/Logo-proyecto.png" width="" height="80" alt=""/>
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle p-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><?php echo $lang['Idioma_activo'] ?><svg xmlns="http://www.w3.org/2000/svg" width="10" height="6" fill="none">
                    ...
                    <ul class="dropdown-menu rounded-2 shadow">
                        <li class="nav-item"><a class="nav-link active" href="contact.php?lang=en"><?php echo $lang['en'] ?></a></li>
                        <li class="nav-item"><a class="nav-link" href="contact.php?lang=es"><?php echo $lang['es'] ?></a></li>
                        <li class="nav-item"><a class="nav-link" href="contact.php?lang=po"><?php echo $lang['po'] ?></a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item navbar-dropdown"><a class="nav-link" href="contact.php"><span><?php echo $lang['About'] ?></span></a>
                    <!--
                    <div class="dropdown-menu rounded-2 shadow">
                        <ul class="nav navbar-nav">
        ...
        <div class="navbar-wrapper">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle p-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><?php echo $lang['Idioma_activo'] ?><svg xmlns="http://www.w3.org/2000/svg" width="10" height="6" fill="none">
                    ...
                    <li class="nav-item active "><a class="nav-link" href="index.php"><span><?php echo $lang['Home'] ?></span></a>
                     ...
                     <li class="nav-item "><a class="nav-link" href="contact.php"><span><?php echo $lang['About'] ?></span></a>                        
                    </li>
  ...
  <!-- Topbar-->
    ...
    <div class="content-wrap ">
        ...
        <div class="col-lg-12">
			<br><br><br>
			<div class="pe-lg-70">
				<h2 class="mb-45" data-show="startbox" data-show-delay="100"><span class="highlight"><?php echo $lang['contact_us'] ?></span></h2>
				
				<div class="contactBox">
				
					<p>
						<input class="cfield" type="text" id="form_name" class="input" value="" name="" type="input" placeholder="<?php echo $lang['form_name'] ?>">
					</p>
					<p>
						<input class="cfield" type="text" id="form_email" class="input" value="" type="email" placeholder="<?php echo $lang['form_email'] ?>">
					</p>
					
					<p>
						<input class="cfield" type="text" id="form_phone" class="input" value="" type="input" placeholder="<?php echo $lang['form_phone'] ?>">
					<p>
					
					<p>
						<select class="cfield" id="form_subject" class="input"  type="select" >
							<option value=""><?php echo $lang['form_subject'] ?></option>
							<option value="<?php echo $lang['Titulo1_s'] ?>"><?php echo $lang['Titulo1_s'] ?></option>
							<option value="<?php echo $lang['Titulo_2_s'] ?>"><?php echo $lang['Titulo_2_s'] ?></option>
							<option value="<?php echo $lang['Titulo3_s'] ?>"><?php echo $lang['Titulo3_s'] ?></option>
							<option value="<?php echo $lang['Titulo4_s'] ?>"><?php echo $lang['Titulo4_s'] ?></option>
							<option value="<?php echo $lang['Titulo5_s'] ?>"><?php echo $lang['Titulo5_s'] ?></option>
							<option value="<?php echo $lang['Titulo6_s'] ?>"><?php echo $lang['Titulo6_s'] ?></option>
							<option value="<?php echo $lang['Titulo7_s'] ?>"><?php echo $lang['Titulo7_s'] ?></option>
						</select>
					</p>

					<p>
						<textarea rows="6" class="cfield" id="contact_message" class="input" type="text" placeholder="Message"></textarea>
					</p>

					
						<button class="cfieldButton" onclick="sendContact()"><?php echo $lang['form_button'] ?></button>
					</p>
	...
	<script>imfoo = "contact";</script>
	
	<script src="app/js/mainGeneral.js"></script>
