=== Date and Time Picker - Calendar, Input field ===
Contributors: inputwp, nirjhar_lo
Donate link: https://www.inputwp.com
Tags: date time picker, booking, calendar, date picker, time picker
...
The **Date and Time Picker** plugin by Input WP allows you to convert a text input field into an advanced Date and Time Picker using a CSS Selector. It works perfectly with Contact Form 7 and Divi.
...
Upgrading to PRO allows you to **add multiple fields** with different rules for each, and a **date range** to your forms by connecting 2 input fields together.Try out the [PRO version](https://www.inputwp.com/pro) today. If you have a feature request, submit it from [here](https://www.inputwp.com/support/).

= Features =

- **CSS selector** — An intuitive way to turn any input field into a date time picker field. Simply assign your input field a class name.
- **Display Calendar** — Allow users to pick a date on the calendar.
- **Display Time** — It allows users to choose the time next to the date picker calendar.
...
To add forms on your site and get the Date and Time Picker plugin working, installing a
contact form plugin is necessary.
...
= Should I keep the Base plugin and the PRO plugin active? =
